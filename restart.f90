subroutine wrrestart
  ...
  write(56) ntime,time
  write(56) totcur0,tflux0,gbound,fbound,ptot,vloop
...
subroutine rdrestart
  ...
  read(56) ntime,time
  read(56) totcur0,tflux0,gbound,fbound,ptot,vloop
  ...
  call numdofs(1, ndofs)
  do j1=1,ndofs 
     read(56,END=1199) bf(j1)
  enddo
  do j1=1,ndofs 
     read(56,END=1199) bf0(j1)
  enddo
  do j1=1,ndofs 
     read(56,END=1199) bfi(j1)
  enddo
