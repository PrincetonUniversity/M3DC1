...
PETSC_WITH_EXTERNAL_LIB = -L$(HDF5DIR)/lib64 -lhdf5hl_fortran -lhdf5_fortran -lhdf5_hl -lhdf5 -lz -L$(PETSC_DIR)/$(PETSC_ARCH)/lib -Wl,-rpath,$(PETSC_DIR)/$(PETSC_ARCH)/lib -L/usr/local/intel/lib64 -L/usr/local/intel/lib64/intel-mpi -L$(MPI_DIR)/lib64 -L$(GSL_ROOT_DIR)/lib64 -L$(INTEL_DIR)/tbb/lib/intel64/gcc4.7 -L$(INTEL_DIR)/compiler/lib/intel64 -L$(INTEL_DIR)/mkl/lib/intel64 -L$(INTEL_DIR)/compiler/lib/intel64_lin -L$(GCC_DIR) -Wl,-rpath,/usr/local/intel/lib64 -Wl,-rpath,/usr/local/intel/lib64/intel-mpi -Wl,-rpath,$(MPI_DIR)/lib64 -lpetsc -lsuperlu_dist -lcmumps -ldmumps -lsmumps -lzmumps -lmumps_common -lpord -lparmetis -lmetis -lsuperlu -lscalapack -lfftw3_mpi -lfftw3 -lflapack -lfblas -lhwloc -lifport -lifcoremt_pic -lrt -lm -lpthread -lz -ldl -L/usr/local/intel/lib64 -L/usr/local/intel/lib64/intel-mpi -L$(MPI_DIR)/lib64 -lmpi -L/usr/local/intel/lib64 -L/usr/local/intel/lib64/intel-mpi -L$(MPI_DIR)/lib64 -L$(GSL_ROOT_DIR)/lib64 -L$(INTEL_DIR)/tbb/lib/intel64/gcc4.7 -L$(INTEL_DIR)/compiler/lib/intel64 -L$(INTEL_DIR)/mkl/lib/intel64 -L/usr/local/intel/lib64 -L$(INTEL_DIR)/compiler/lib/intel64_lin -L$(GSL_ROOT_DIR)/lib64 -L$(GSL_ROOT_DIR)/lib64 -L/usr/local/intel/lib64 -L/usr/local/intel/lib64 -L$(GCC_DIR) -L$(GSL_ROOT_DIR)/lib64 -L$(GSL_ROOT_DIR)/lib64 -L$(INTEL_DIR)/tbb/lib/intel64/gcc4.7 -L$(INTEL_DIR)/compiler/lib/intel64 -L$(INTEL_DIR)/mkl/lib/intel64 -L/usr/local/intel/lib64 -L/usr/local/intel/lib64 -Wl,-rpath,/usr/local/intel/lib64 -Wl,-rpath,/usr/local/intel/lib64/intel-mpi -Wl,-rpath,$(MPI_DIR)/lib64 -limf -lsvml -lirng -lm -lipgo -ldecimal -lcilkrts -lstdc++ -lgcc_s -lirc -lpthread -lirc_s -L/usr/local/intel/lib64 -L/usr/local/intel/lib64/intel-mpi -L$(MPI_DIR)/lib64 -L$(GSL_ROOT_DIR)/lib64 -L$(INTEL_DIR)/tbb/lib/intel64/gcc4.7 -L$(INTEL_DIR)/compiler/lib/intel64 -L$(INTEL_DIR)/mkl/lib/intel64 -L/usr/local/intel/lib64 -L$(INTEL_DIR)/compiler/lib/intel64_lin -L$(GSL_ROOT_DIR)/lib64 -L$(GSL_ROOT_DIR)/lib64 -L/usr/local/intel/lib64 -L/usr/local/intel/lib64 -L$(GCC_DIR) -L$(GSL_ROOT_DIR)/lib64 -L$(GSL_ROOT_DIR)/lib64 -L$(INTEL_DIR)/tbb/lib/intel64/gcc4.7 -LL$(INTEL_DIR)/compiler/lib/intel64 -L$(INTEL_DIR)/mkl/lib/intel64 -L/usr/local/intel/lib64 -L/usr/local/intel/lib64 -ldl
...
SCOREC_BASE_DIR=/home/jinchen/LIB/scorec/intel18.0-mpi2018.3.64
