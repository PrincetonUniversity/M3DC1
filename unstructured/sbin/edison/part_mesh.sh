...
SPLIT_SMB=/global/project/projectdirs/mp288/edison/scorec/utilities/split_smb/split_smb
MAKE_MODEL=/global/project/projectdirs/mp288/edison/scorec/utilities/split_smb/make_model
MESH_FILE=mesh.smb
...
#	srun -n 1 $SPLIT_SMB $1 part.smb $2
    fi
fi
