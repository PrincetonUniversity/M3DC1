...
def plot_time_trace(trace,sim=None,units='mks',filename='C1.h5',growth=False,renorm=False,yscale='linear'):
    ...
    **yscale**
    ...
    if trace=='me':
        ...
        if units=='mks':
            y_axis = unit_conv(y_axis, arr_dim='M3DC1', filename=filename, energy=1)
    ...
    if trace=='it':
        ...
        if units=='mks':
            y_axis = unit_conv(y_axis, arr_dim='M3DC1', filename=filename, current=1)
    ...
    if trace=='vl':
        ...
        if units=='mks':
            y_axis = unit_conv(y_axis, arr_dim='M3DC1', filename=filename, voltage=1)
    ...
    if trace=='psibound' or trace=='psilim':
        ...
        if units=='mks':
            y_axis = unit_conv(y_axis, arr_dim='M3DC1', filename=filename, magnetic_field=1, length=2)
    ...
    if trace=='dt':
        ...
        if units=='mks':
            y_axis = unit_conv(y_axis, filename=filename,time=1)
            plt.ylabel(r'Time $[s]$')
    ...
    if trace=='volume':
        ...
        if units=='mks':
            y_axis = unit_conv(y_axis, filename=filename,length=3)
    ...
    if trace=='toroidal flux':
        ...
        if units=='mks':
            y_axis = unit_conv(y_axis, filename=filename,magnetic_field=1,length=2)
            plt.ylabel(r'Current $[T][m]^2$')
    ...
    if trace=='temax':
        ...
        if units=='mks':
            y_axis = unit_conv(y_axis, filename=filename,temperature=1)
    ...
    if trace=='p':
        ...
        if units=='mks':
            y_axis = unit_conv(y_axis, filename=filename,energy=1)
    ...
    if trace=='n':
        ...
        if units=='mks':
            y_axis = unit_conv(y_axis, filename=filename,particles=1)
    ...
    if trace=='angular momentum':
        ...
        if units=='mks':
            y_axis = unit_conv(y_axis, filename=filename,energy=1,time=1)
    ...
    if trace=='vorticity':
        ...
        if units=='mks':
            y_axis = unit_conv(y_axis, filename=filename,length=2,time=-1)
    ...
    if trace=='bwb2':
        ...
        if units=='mks':
            ...
            y_axis = unit_conv(y_axis, filename=filename,energy=1,time=-2,length=3)
    ...
    if trace=='flux':
        ...
        if units=='mks':
            y_axis = unit_conv(y_axis, filename=filename,length=2,magnetic_field=-1)
            plt.ylabel(r'Normalized inductance')
    ...
    if trace=='xmag':
        ...
        if units=='mks':
            y_axis = unit_conv(y_axis, filename=filename,length=1)
    ...
    if trace=='pelr':
        ...
        # Not too sure about dimensions
        if units=='mks':
            y_axis = unit_conv(y_axis, filename=filename,particles=1,time=-1)
