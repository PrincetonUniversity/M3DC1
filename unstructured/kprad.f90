...
!       initial Zeff ~ 2
  ...
  subroutine kprad_atomic_data_sub(Z, ierr)
    ...
    case (5) !SET BORON FOR IMPURITY
       ...
       C=RESHAPE((/ -11.9222, -0.4985, 0.0059,  0.0145, -0.0137, -0.0053,  0.0017,  0.0016,   &
            -12.0848, -0.4904, -0.0162,  0.0038,  0.0028,  0.0037, -0.0025, -0.0001,  &
            -12.5950, -0.4981,  0.0101,  0.0225, -0.0224, -0.0080,  0.0034,  0.0022,  &
            -11.8129,  0.3654, -4.7181, -1.2651,  3.8270,  1.1646, -0.8740, -0.2600,  &
            -12.2021,  0.7518, -4.5879, -1.8736,  3.7387,  1.4681, -0.8798, -0.2924 /), &
            (/8,5/))
       SION_COEFF=RESHAPE((/ -11.5801,  9.2170, -9.2920,  6.3654, -3.0856,  1.0162, -0.2134,  0.0256, -0.0013,    &
            -19.2747, 25.6056,  -28.2128, 20.1278, -9.7528,  3.1570, -0.6491,  0.0762, -0.0039,    &
            -25.2355, 38.1765,  -42.3932, 30.0563 , -14.4159,  4.6315, -0.9488,  0.1114, -0.0057,   &
            -122.2477,  252.9587, -275.4335 , 186.7180 , -84.0421, 25.1449, -4.7973,  0.5267, -0.0252, &
            -156.3058 , 326.4923, -350.1184 , 232.2898, -102.1319, 29.8719, -5.5826,  0.6019, -0.0284/), &
            (/9,5/))
