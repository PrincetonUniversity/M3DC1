...
1000      format(i4,1p8e12.4)
  ...
  real function qfunc(psi)    !   q  (safety factor)
    ...
    case(30)
       ...
       x = sqrt(psi)
       xbtheta=(atan(psi)/4.+(x/2.+(x-1)**2/4.-1./4.)/(4.*x+6.*(x-1)**2+4.*(x-1)**3+(x-1)**4-2.)-5.*(1-x)**(1./2.)+(70.*(1-x)**(3./2.))/3.-91.*(1-x)**(5./2.)+260.*(1-x)**(7./2.)-(5005.*(1-x)**(9./2.))/9.+910.*(1-x)**(11./2.)-1155.*(1-x)**(13./2.)+1144.*(1-x)**(15./2.)-(15015.*(1-x)**(17./2.))/17.+(10010.*(1-x)**(19./2.))/19.-(715.*(1-x)**(21./2.))/3.+(1820.*(1-x)**(23./2.))/23.-(91.*(1-x)**(25./2.))/5.+(70.*(1-x)**(27./2.))/27.-(5.*(1-x)**(29./2.))/29.)
  ...
  real function qpfunc(psi)   !   derivative of q wrt psi
    ...
    case(30)
       ...
       qpfunc= (2.*x*xbtheta-psi*(2.*x/(4.*(1+psi))+(-2.+6.*x-4.*x**2+6.*(x-1)**2+(x-1)**3-3.*(x-1)**4-(x-1)**5-6.*x*(x-1)**2+(x*(x-1)**4)/2.)/((4.*x+6.*(x-1)**2+4.*(x-1)**3+(x-1)**4-2.)**2)+(5.*(1-x)**(-1./2.))/2.-(70.*(1-x)**(1./2.))/2.+(5.*91.*(1-x)**(3./2.))/2.-(7.*260.*(1-x)**(5./2.))/2.+(5005.*(1-x)**(7./2.))/2.-(910.*11.*(1-x)**(9./2.))/2.+(1155.*13.*(1-x)**(11./2.))/2.-(1144.*15.*(1-x)**(13./2.))/2.+(15015.*(1-x)**(15./2.))/2.-(10010.*(1-x)**(17./2.))/2.+(715.*7.*(1-x)**(19./2.))/2.-(1820.*(1-x)**(21./2.))/2.+(91.*5.*(1-x)**(23./2.))/2.-(70.*(1-x)**(25./2.))/2.+(5.*(1-x)**(27./2.))/2.))/(2.*x*xbtheta**2) 
