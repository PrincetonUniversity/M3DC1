...
ifeq ($(COM), 1)
 ...
 PETSC_WITH_EXTERNAL_LIB = -L${PETSC_DIR}/${PETSC_ARCH}/lib -Wl,-rpath,/projects/M3DC1/PETSC/$(PETSC_VER)/$(PETSC_ARCH)/lib -L/projects/M3DC1/PETSC/$(PETSC_VER)/$(PETSC_ARCH)/lib -Wl,-rpath,/usr/local/fftw/intel-2021.1/intel-mpi/3.3.9/lib -L/usr/local/fftw/intel-2021.1/intel-mpi/3.3.9/lib -Wl,-rpath,/usr/local/hdf5/intel-2021.1/intel-mpi/1.10.6/lib64 -L/usr/local/hdf5/intel-2021.1/intel-mpi/1.10.6/lib64 -L/opt/intel/oneapi/mpi/2021.3.1/lib/release -L/opt/intel/oneapi/mpi/2021.3.1/lib -L/usr/local/gsl/2.6/x86_64/lib64 -L/usr/local/fftw/intel-2021.1/intel-mpi/3.3.9/lib64 -L/opt/intel/oneapi/mpi/2021.3.1/libfabric/lib -L/opt/intel/oneapi/mkl/2021.1.1/lib/intel64 -L/opt/intel/oneapi/tbb/2021.1.1/lib/intel64/gcc4.8 -L/opt/intel/oneapi/compiler/2021.1.2/linux/lib -L/opt/intel/oneapi/compiler/2021.1.2/linux/compiler/lib/intel64_lin -L/usr/lib/gcc/x86_64-redhat-linux/8 -Wl,-rpath,/opt/intel/oneapi/mpi/2021.3.1/lib/release -Wl,-rpath,/opt/intel/oneapi/mpi/2021.3.1/lib -lpetsc -lcmumps -ldmumps -lsmumps -lzmumps -lmumps_common -lpord -lscalapack -lsuperlu -lsuperlu_dist -lfftw3_mpi -lfftw3 -lflapack -lfblas -lzoltan -lhdf5hl_fortran -lhdf5_fortran -lhdf5_hl -lhdf5 -lparmetis -lmetis -lz -lX11 -lstdc++ -ldl -lmpifort -lmpi -lrt -lpthread -lifport -lifcoremt -limf -lsvml -lm -lipgo -lirc -lgcc_s -lirc_s -lquadmath -lstdc++ -ldl
