     ...
     if(itemp.eq.0) then
        if(total_pressure) then
           ...
           if(use_totrad) then
              ...
              r4term = r4term + dt*(gam-1.)*b3q(trialx,linerad79)
              r4term = r4term + dt*(gam-1.)*b3q(trialx,bremrad79)
              r4term = r4term + dt*(gam-1.)*b3q(trialx,ionrad79)
              r4term = r4term + dt*(gam-1.)*b3q(trialx,reckrad79)
           end if
        else
           ! Electron pressure
           ! ~~~~~~~~~~~~~~~~~
