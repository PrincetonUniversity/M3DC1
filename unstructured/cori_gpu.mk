...
ifeq ($(COM), 1)
  PETSC_ARCH=cplx-intel-mpi7.7.3-gpu
else
  PETSC_ARCH=cori-gpu-mpich771-real-nomkl-540
endif

PETSC_WITH_EXTERNAL_LIB = -L$(PETSC_DIR)/$(PETSC_ARCH)/lib -Wl,-rpath,$(PETSC_DIR)/$(PETSC_ARCH)/lib -lpetsc -lsuperlu -lsuperlu_dist -lptscotch -lptscotcherr -lscotch -lscotcherr -lfftw3_mpi -lfftw3 -lparmetis -lmetis -lrt -lm -lpthread -lz -ldl -lstdc++
