...
ifeq ($(COM), 1)
PETSC_ARCH=cplx-rhel6-intel2019u3-openmpi4.0.3
else
PETSC_ARCH=real-rhel6-intel2019u3-openmpi4.0.3
endif

SCOREC_BASE_DIR=/p/tsc/m3dc1/lib/SCORECLib/rhel6/intel2019u3-openmpi4.0.3/$(PETSCVER)
