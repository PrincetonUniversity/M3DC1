...
function v1umu(e,f,g,h)
  ...
  case(0)
     ...
     if(surface_int) then
        ...
        temp = -intx3(e(:,:,OP_GS),f(:,OP_GS),g(:,OP_1)) &
             -  intx3(e(:,:,OP_DR),f(:,OP_GS),g(:,OP_DR)) &
             -  intx3(e(:,:,OP_DZ),f(:,OP_GS),g(:,OP_DZ)) &
             -  intx3(e(:,:,OP_DR),f(:,OP_DR),g(:,OP_GS)) &
             -  intx3(e(:,:,OP_DZ),f(:,OP_DZ),g(:,OP_GS)) &
             -  intx3(e(:,:,OP_GS),f(:,OP_DR),g(:,OP_DR)) &
             -  intx3(e(:,:,OP_GS),f(:,OP_DZ),g(:,OP_DZ))

        if(itor.eq.1) then
           temp = temp &
                - 4.*intx4(e(:,:,OP_DR),ri_79,f(:,OP_GS),g(:,OP_1 )) &
                - 2.*intx4(e(:,:,OP_1 ),ri_79,f(:,OP_GS),g(:,OP_DR)) &
                - 2.*intx4(e(:,:,OP_DR),ri_79,f(:,OP_DR),g(:,OP_DR)) &
                - 2.*intx4(e(:,:,OP_DZ),ri_79,f(:,OP_DZ),g(:,OP_DR)) &
                - 4.*intx4(e(:,:,OP_DR),ri_79,f(:,OP_DR),g(:,OP_DR)) &
                - 4.*intx4(e(:,:,OP_DZ),ri_79,f(:,OP_DZ),g(:,OP_DZ)) &
                - 2.*intx4(e(:,:,OP_1),ri_79,g(:,OP_LP),f(:,OP_DR))
        endif
        ...
        if(itor.eq.1) then
           temp = temp + &
                2.*intx4(e(:,:,OP_1),ri3_79,f(:,OP_DRPP),g(:,OP_1))
        endif
#endif
     endif
...
function v1chimu(e,f,g,h)
  ...
  case(0)
     if(surface_int) then
        ...
        temp = intx3(e(:,:,OP_LP),r_79,temp79a) &
             + intx4(e(:,:,OP_DZ),r_79,f(:,OP_DR),g(:,OP_GS)) &
             - intx4(e(:,:,OP_DR),r_79,f(:,OP_DZ),g(:,OP_GS)) &
             + intx4(e(:,:,OP_DZ),r_79,f(:,OP_GS),g(:,OP_DR)) &
             - intx4(e(:,:,OP_DR),r_79,f(:,OP_GS),g(:,OP_DZ))
        
        if(itor.eq.1) then
           temp = temp &
                - 2.*intx3(e(:,:,OP_1),f(:,OP_GS),g(:,OP_DZ)) &
                + 4.*intx2(e(:,:,OP_DR),temp79a) &
                + 4.*intx3(e(:,:,OP_1),ri_79,temp79a) &
                - 2.*intx3(e(:,:,OP_1),f(:,OP_DZ),g(:,OP_GS)) &
                + 4.*intx3(e(:,:,OP_DZ),f(:,OP_DR),g(:,OP_DR)) &
                - 4.*intx3(e(:,:,OP_DR),f(:,OP_DR),g(:,OP_DZ)) &
                - 8.*intx4(e(:,:,OP_1),ri_79,f(:,OP_DR),g(:,OP_DZ))
...
function v1psipsi(e,f,g)
  ...
  case(0)
     if(surface_int) then
        ...
        if(itor.eq.1) then
           temp = temp - 2.*intx4(e(:,:,OP_1),ri2_79,f(:,OP_DZ),g(:,OP_GS))
        endif
     end if
  case(1)
     if(surface_int) then
  ...
  case(0)
     if(surface_int) then
        ...
        if(itor.eq.0) then
           ...
           temp = -2.*intx4(e(:,:,OP_1),ri2_79,f(:,OP_DZ),g(:,OP_1)) 
        endif
     endif
...
function v1upsipsi(e,f,g,h)
  ...
  case(0)  
     ...
     if(surface_int) then
        ...
        temp =-intx3(tempe,ri2_79,temp79b) &
             - intx3(tempf,ri2_79,temp79c) &
             + intx4(e(:,:,OP_DZ),ri2_79,temp79b,h(:,OP_GS)) &
             - intx4(e(:,:,OP_DR),ri2_79,temp79c,h(:,OP_GS))
        ...
        if(itor.eq.1) then
           ...
           temp = temp &
                -    intx4(e(:,:,OP_DZ),ri3_79,temp79a,h(:,OP_GS)) &
                - 2.*intx4(e(:,:,OP_1 ),ri3_79,temp79c,h(:,OP_GS)) &
                +    intx3(tempe,ri3_79,temp79a) &
                -    intx3(tempd,ri3_79,temp79b) &
                + 2.*intx4(e(:,:,OP_1 ),ri3_79,temp79b,h(:,OP_DRZ)) &
                + 2.*intx4(e(:,:,OP_1 ),ri3_79,temp79c,h(:,OP_DZZ)) &
                + 2.*intx4(e(:,:,OP_DR),ri3_79,temp79b,h(:,OP_DZ )) &
                + 2.*intx4(e(:,:,OP_DZ),ri3_79,temp79c,h(:,OP_DZ )) &
                +    intx3(tempd,ri4_79,temp79a) &
                - 2.*intx4(e(:,:,OP_DR),ri4_79,temp79a,h(:,OP_DZ )) &
                - 2.*intx4(e(:,:,OP_1 ),ri4_79,temp79a,h(:,OP_DRZ))
        endif
     end if
...
function v1upsib(e,f,g,h)
  ...
  case(0)
     if(surface_int) then
        ...
        do j=1, dofs_per_element
           tempa(j,:) = g(:,OP_DR)* &
                (e(j,:,OP_DZZ)*f(:,OP_DZP)-e(j,:,OP_DZ)*f(:,OP_DZZP) &
                +e(j,:,OP_DRZ)*f(:,OP_DRP)-e(j,:,OP_DR)*f(:,OP_DRZP))&
                -g(:,OP_DZ)* &
                (e(j,:,OP_DRR)*f(:,OP_DRP)-e(j,:,OP_DR)*f(:,OP_DRRP) &
                +e(j,:,OP_DRZ)*f(:,OP_DZP)-e(j,:,OP_DZ)*f(:,OP_DRZP))
        end do


        temp = -intx3(tempa,ri3_79,h(:,OP_1))

        if(itor.eq.1) then
           do j=1, dofs_per_element
              tempa(j,:) = g(:,OP_DZ)* &
                   (e(j,:,OP_1)*f(:,OP_DRRP) - e(j,:,OP_DZ)*f(:,OP_DZP) &
                   - 2.*e(j,:,OP_DR)*f(:,OP_DRP)) &
                   +    g(:,OP_DR)* &
                   (e(j,:,OP_DZ)*f(:,OP_DRP) - e(j,:,OP_1 )*f(:,OP_DRZP))
           end do
           temp = temp &
                - 2.*intx3(tempa,ri4_79,h(:,OP_1)) &
                + 2.*intx5(e(:,:,OP_1),ri5_79,f(:,OP_DRP),g(:,OP_DZ),h(:,OP_1))
        endif
     end if
...
function v1ubb(e,f,g,h)
  ...
  case(0)
     if(surface_int) then
        ...
        if(itor.eq.1) then
           temp = 2.* &
                (   intx5(e(:,:,OP_DZ),ri3_79,f(:,OP_DZ),g(:,OP_DR),h(:,OP_1))&
                -   intx5(e(:,:,OP_DZ),ri3_79,f(:,OP_DR),g(:,OP_DZ),h(:,OP_1))&
                -2.*intx5(e(:,:,OP_DZ),ri4_79,f(:,OP_DZ),g(:,OP_1 ),h(:,OP_1)))
        endif
        
#if defined(USE3D) || defined(USECOMPLEX)
        temp = temp + &
             (intx5(e(:,:,OP_DZ),ri4_79,f(:,OP_DZPP),g(:,OP_1),h(:,OP_1)) &
             +intx5(e(:,:,OP_DR),ri4_79,f(:,OP_DRPP),g(:,OP_1),h(:,OP_1)))
        if(itor.eq.1) then
           temp = temp + &
                2.*intx5(e(:,:,OP_1),ri5_79,f(:,OP_DRPP),g(:,OP_1),h(:,OP_1))
        endif
#endif
     end if
...
function v1vpsipsi(e,f,g,h)
  ...
  case(0)
     if(surface_int) then
        ...
        do j=1, dofs_per_element
           tempa(j,:) = g(:,OP_DZ)* &
                ( h(:,OP_DZ)*e(j,:,OP_DRZ) + h(:,OP_DR)*e(j,:,OP_DRR)  &
                - e(j,:,OP_DZ)*h(:,OP_DRZ) - e(j,:,OP_DR)*h(:,OP_DRR)) &
                + g(:,OP_DR)* &
                ( e(j,:,OP_DR)*h(:,OP_DRZ) + e(j,:,OP_DZ)*h(:,OP_DZZ)  &
                - h(:,OP_DR)*e(j,:,OP_DRZ) - h(:,OP_DZ)*e(j,:,OP_DZZ))
        end do
        temp = -intx3(tempa,ri3_79,f(:,OP_DP))

        if(itor.eq.1) then
           do j=1, dofs_per_element
              tempa(j,:) = e(j,:,OP_DZ)* &
                   (g(:,OP_DZ)*h(:,OP_DZ ) + g(:,OP_DR)*h(:,OP_DR)) &
                   + 2.*e(j,:,OP_DR)*(g(:,OP_DZ)*h(:,OP_DR )) &
                   +    e(j,:,OP_1) * &
                   (g(:,OP_DR)*h(:,OP_DZZ) - g(:,OP_DZ)*h(:,OP_DRR))
           end do
           temp = temp &
                -2.*intx3(tempa,ri4_79,f(:,OP_DP)) &
                -2.*intx5(e(:,:,OP_1),ri5_79,f(:,OP_DP),g(:,OP_DZ),h(:,OP_DR))
        endif
     end if
...
function v1vpsib(e,f,g,h)
  ...
  case(0)
     if(surface_int) then
        ...
        if(itor.eq.1) then
           temp = temp + &
             2.*(   intx5(e(:,:,OP_DZ),ri3_79,f(:,OP_DZ),g(:,OP_DR),h(:,OP_1))&
                -   intx5(e(:,:,OP_DZ),ri3_79,f(:,OP_DR),g(:,OP_DZ),h(:,OP_1))&
                +2.*intx5(e(:,:,OP_DZ),ri4_79,f(:,OP_1 ),g(:,OP_DZ),h(:,OP_1)))
        endif
#if defined(USE3D) || defined(USECOMPLEX)
        temp = temp - &
             (intx5(e(:,:,OP_DZ),ri4_79,f(:,OP_DPP),g(:,OP_DZ),h(:,OP_1)) &
             +intx5(e(:,:,OP_DR),ri4_79,f(:,OP_DPP),g(:,OP_DR),h(:,OP_1)))
        if(itor.eq.1) then
           temp = temp - &
                2.*intx5(e(:,:,OP_1),ri5_79,f(:,OP_DPP),g(:,OP_DR),h(:,OP_1))
        endif
#endif
     end if
...
function v1chipsipsi(e,f,g,h)
  ...
  case(0)
     if(surface_int) then
        ...
        temp = intx3(tempe,ri_79,temp79b) &
             + intx3(tempf,ri_79,temp79c) &
             + intx4(e(:,:,OP_DR),ri_79,temp79c,h(:,OP_GS)) &
             - intx4(e(:,:,OP_DZ),ri_79,temp79b,h(:,OP_GS))
     
        if(itor.eq.1) then
           temp79a = f(:,OP_DZ)*g(:,OP_DZ) + f(:,OP_DR)*g(:,OP_DR)
           
           temp = temp + 2.* &
                (intx4(e(:,:,OP_1 ),ri2_79,temp79c,h(:,OP_GS )) &
                -intx4(e(:,:,OP_1 ),ri2_79,temp79b,h(:,OP_DRZ)) &
                -intx4(e(:,:,OP_1 ),ri2_79,temp79c,h(:,OP_DZZ)) &
                -intx4(e(:,:,OP_DR),ri2_79,temp79b,h(:,OP_DZ )) &
                -intx4(e(:,:,OP_DZ),ri2_79,temp79c,h(:,OP_DZ )) &
                +intx4(e(:,:,OP_DZ),ri2_79,temp79b,h(:,OP_DR )) &
                -intx4(e(:,:,OP_DR),ri2_79,temp79b,h(:,OP_DZ )))
        endif
     end if
...
function v1chipsib(e,f,g,h) 
  ...
  case(0)
     if(surface_int) then
        ...
        do j=1, dofs_per_element
           tempa(j,:) = f(:,OP_DRP )*e(j,:,OP_DZZ)-f(:,OP_DZP )*e(j,:,OP_DRZ) &
                -    f(:,OP_DRRP)*e(j,:,OP_DR )-f(:,OP_DRZP)*e(j,:,OP_DZ )
           tempb(j,:) = f(:,OP_DZP )*e(j,:,OP_DRR)-f(:,OP_DRP )*e(j,:,OP_DRZ) &
                -    f(:,OP_DRZP)*e(j,:,OP_DR )-f(:,OP_DZZP)*e(j,:,OP_DZ )
        end do
        
        temp = temp  &
             + intx4(tempa,ri2_79,g(:,OP_DR),h(:,OP_1)) &
             + intx4(tempb,ri2_79,g(:,OP_DZ),h(:,OP_1))
        
        if(itor.eq.1) then
           temp = temp &
             -    intx5(e(:,:,OP_DR),ri3_79,f(:,OP_DRP),g(:,OP_DR),h(:,OP_1)) &
             - 2.*intx5(e(:,:,OP_1),ri3_79,f(:,OP_DRRP),g(:,OP_DR),h(:,OP_1)) &
             - 2.*intx5(e(:,:,OP_1),ri4_79,f(:,OP_DRP), g(:,OP_DR),h(:,OP_1)) &
             +    intx5(e(:,:,OP_DR),ri3_79,f(:,OP_DZP),g(:,OP_DZ),h(:,OP_1)) &
             - 2.*intx5(e(:,:,OP_DZ),ri3_79,f(:,OP_DRP),g(:,OP_DZ),h(:,OP_1)) &
             - 2.*intx5(e(:,:,OP_1),ri3_79,f(:,OP_DRZP),g(:,OP_DZ),h(:,OP_1))
        endif
     end if
...
function v1chibb(e,f,g,h)
  ...
  case(0)
     if(surface_int) then
        ...
        if(itor.eq.1) then
           temp = temp -2.* &
                (intx5(e(:,:,OP_DZ),ri2_79,g(:,OP_1 ),f(:,OP_GS),h(:,OP_1)) &
                +intx5(e(:,:,OP_DZ),ri2_79,g(:,OP_DZ),f(:,OP_DZ),h(:,OP_1)) &
                +intx5(e(:,:,OP_DZ),ri2_79,g(:,OP_DR),f(:,OP_DR),h(:,OP_1)))
        endif

#if defined(USE3D) || defined(USECOMPLEX)
        temp = temp &
             + intx5(e(:,:,OP_DR),ri3_79,f(:,OP_DZPP),g(:,OP_1),h(:,OP_1)) &
             - intx5(e(:,:,OP_DZ),ri3_79,f(:,OP_DRPP),g(:,OP_1),h(:,OP_1))
        
        if(itor.eq.1) then
           temp = temp + &
                2.*intx5(e(:,:,OP_1),ri4_79,f(:,OP_DZPP),g(:,OP_1),h(:,OP_1))
        endif
#endif
     end if
...
function v1us(e,f,g)
  ...
  case(0)
     if(surface_int) then
        ...
        if(itor.eq.1) then 
           temp = temp - 2.*intx4(e(:,:,OP_1),ri_79,f(:,OP_DR),temp79a)
        endif
     end if
...
function v1chis(e,f,g)
  ...
  case(0)
     if(surface_int) then
        ...
        temp = intx4(e(:,:,OP_DZ),r_79,f(:,OP_DR),temp79a) &
             - intx4(e(:,:,OP_DR),r_79,f(:,OP_DZ),temp79a)

        if(itor.eq.1) then 
           temp = temp - 2.*intx3(e(:,:,OP_1),f(:,OP_DZ),temp79a)
        endif
     end if
...
function v1psif(e,f,g)
  ...
  case(0)
     if(surface_int) then
        ...
        temp = &
             - intx3(e(:,:,OP_DZ),f(:,OP_GS),g(:,OP_DZP)) &
             - intx3(e(:,:,OP_DR),f(:,OP_GS),g(:,OP_DRP))
        if(itor.eq.1) then
           temp = temp - 2.* & 
                intx4(e(:,:,OP_1),ri_79,f(:,OP_GS),g(:,OP_DRP))
        endif
     end if
  ...
  case(1)
     ...
     if(surface_int) then
        if(inoslip_pol.eq.1) then
           ...
           temp =  &
                + intx4(e(:,:,OP_1),f(:,OP_GS),norm79(:,1),g(:,OP_DRP)) &
                + intx4(e(:,:,OP_1),f(:,OP_GS),norm79(:,2),g(:,OP_DZP))
        endif
     else
        temp = &
             - intx3(e(:,:,OP_DZ),f(:,OP_GS),g(:,OP_DZP)) &
...
function v1bf(e,f,g)
  ...
  case(0)
     if(surface_int) then
        ...
        if(itor.eq.1) then
           temp = temp - 2.* & 
                intx4(e(:,:,OP_1),ri2_79,f(:,OP_1),g(:,OP_DZPP))
        endif
     end if
  ...
  case(1)
     if(surface_int) then
        if(inoslip_pol.eq.1) then
           ...
           temp = &
                + intx5(e(:,:,OP_1),ri_79,f(:,OP_1),norm79(:,1),g(:,OP_DZPP)) &
                - intx5(e(:,:,OP_1),ri_79,f(:,OP_1),norm79(:,2),g(:,OP_DRPP))
        end if
     else
        temp = &
             + intx4(e(:,:,OP_DZ),ri_79,f(:,OP_1),g(:,OP_DRPP)) &
...
function v2vn(e,f,g)
  ...
  select case(ivform)
  case(0)
     v2vn = intx3(e(:,:,OP_1),f(:,OP_1),g(:,OP_1))
  case(1)
...
function v2vmu(e,f,g,h)
  ...
  case(0)
     if(surface_int) then
        ...
        if(itor.eq.1) then
           temp = temp - 2.*intx4(e(:,:,OP_1),ri_79,f(:,OP_1),g(:,OP_DR))
        endif

#if defined(USE3D) || defined(USECOMPLEX)
        temp = temp + 2.*intx4(e(:,:,OP_1),ri2_79,f(:,OP_DPP),h(:,OP_1))
#endif
        ...
        if(hypv.ne.0.) then
           if(ihypamu.eq.1) then
              ...
              temp = temp - hypv* &
                   intx2(e(:,:,OP_GS),f(:,OP_GS))
              if(itor.eq.1) then 
                 temp = temp - hypv* &
                      4.*intx3(e(:,:,OP_DR),ri_79,f(:,OP_GS))
              end if
           endif
        endif
     end if
...
function v2vun(e,f,g,h)
  ...
  select case(ivform)
  case(0)
     temp = intx5(e(:,:,OP_1),ri_79,f(:,OP_DR),g(:,OP_DZ),h(:,OP_1)) &
          - intx5(e(:,:,OP_1),ri_79,f(:,OP_DZ),g(:,OP_DR),h(:,OP_1))
  case(1)
...
function v2vvn(e,f,g,h)
  ...
  select case(ivform)
  case(0)
     temp = -intx5(e(:,:,OP_1),ri2_79,f(:,OP_1),g(:,OP_DP),h(:,OP_1))
  case(1)
...
function v2vpsipsi(e,f,g,h)
  ...
  case(0)
     if(surface_int) then
        ...
        temp = intx4(tempa,ri2_79,f(:,OP_DR),g(:,OP_DZ)) &
             - intx4(tempa,ri2_79,f(:,OP_DZ),g(:,OP_DR))
        if(itor.eq.1) then
           temp = temp - 2.*intx4(tempa,ri3_79,f(:,OP_1),g(:,OP_DZ))
        endif

#if defined(USE3D) || defined(USECOMPLEX)
        temp = temp + &
             (intx5(e(:,:,OP_1),ri4_79,f(:,OP_DPP),g(:,OP_DZ),h(:,OP_DZ)) &
             +intx5(e(:,:,OP_1),ri4_79,f(:,OP_DPP),g(:,OP_DR),h(:,OP_DR)))
#endif
     end if
...
function v2vpsib(e,f,g,h)
  ...
  case(0)
     if(surface_int) then
        ...
        temp = intx3(e(:,:,OP_1),ri3_79,temp79a) &
             + intx5(e(:,:,OP_1),ri3_79,f(:,OP_DZ),g(:,OP_DR),h(:,OP_DP)) &
             - intx5(e(:,:,OP_1),ri3_79,f(:,OP_DR),g(:,OP_DZ),h(:,OP_DP))
        if(itor.eq.1) then
           temp = temp + 2.* &
                intx5(e(:,:,OP_1),ri4_79,f(:,OP_1),g(:,OP_DZ),h(:,OP_DP))
        endif
     end if
  ...
  case(0)
     if(surface_int) then
        ...
        if(itor.eq.1) then
           ...
           temp = temp + intx3(e(:,:,OP_1),ri4_79,temp79a)
        endif
     end if
...
function v2upsib(e,f,g,h)
  ...
  case(0)
     ...
     if(surface_int) then
        ...
        temp = intx4(tempa,ri2_79,g(:,OP_DR),h(:,OP_DZ)) &
             - intx4(tempa,ri2_79,g(:,OP_DZ),h(:,OP_DR))
        if(itor.eq.1) then
           temp = temp + 2.* &
                (intx5(e(:,:,OP_DZ),ri3_79,f(:,OP_DZ),g(:,OP_DR),h(:,OP_1)) &
                -intx5(e(:,:,OP_DR),ri3_79,f(:,OP_DZ),g(:,OP_DZ),h(:,OP_1)))
        endif

#if defined(USE3D) || defined(USECOMPLEX)
        temp = temp - &
             (intx5(e(:,:,OP_1),ri4_79,f(:,OP_DZPP),g(:,OP_DZ),h(:,OP_1)) &
             +intx5(e(:,:,OP_1),ri4_79,f(:,OP_DRPP),g(:,OP_DR),h(:,OP_1)))
#endif
     end if
...
function v2ubb(e,f,g,h)
  ...
  case(0)
     if(surface_int) then
        ...
        if(itor.eq.1) then
           temp = temp - 2.* &
                intx5(e(:,:,OP_1),ri4_79,f(:,OP_DZ),g(:,OP_1),h(:,OP_DP))
        endif
     end if
...
function v2chipsipsi(e,f,g,h)
  ...
  case(0)
     if(surface_int) then
        ...
        temp = temp  &
             +intx5(e(:,:,OP_1),ri2_79,f(:,OP_DRRP),g(:,OP_DR ),h(:,OP_DR)) &
             +intx5(e(:,:,OP_1),ri2_79,f(:,OP_DRP ),g(:,OP_DRR),h(:,OP_DR)) &
             +intx5(e(:,:,OP_1),ri2_79,f(:,OP_DRZP),g(:,OP_DZ ),h(:,OP_DR)) &
             +intx5(e(:,:,OP_1),ri2_79,f(:,OP_DZP ),g(:,OP_DRZ),h(:,OP_DR)) &
             +intx5(e(:,:,OP_1),ri2_79,f(:,OP_DRZP),g(:,OP_DR ),h(:,OP_DZ)) &
             +intx5(e(:,:,OP_1),ri2_79,f(:,OP_DRP ),g(:,OP_DRZ),h(:,OP_DZ)) &
             +intx5(e(:,:,OP_1),ri2_79,f(:,OP_DZZP),g(:,OP_DZ ),h(:,OP_DZ)) &
             +intx5(e(:,:,OP_1),ri2_79,f(:,OP_DZP ),g(:,OP_DZZ),h(:,OP_DZ))
     end if
...
function v2chipsib(e,f,g,h)
  ...
  case(0)
     if(surface_int) then
        ...
        temp = intx3(tempc,ri_79,temp79a) &
             + intx4(tempb,ri_79,f(:,OP_DZ),g(:,OP_DZ)) &
             + intx4(tempb,ri_79,f(:,OP_DR),g(:,OP_DR)) 
#if defined(USE3D) || defined(USECOMPLEX)
        temp = temp  &
             -intx5(e(:,:,OP_1),ri3_79,f(:,OP_DZPP),g(:,OP_DR),h(:,OP_1)) &
             +intx5(e(:,:,OP_1),ri3_79,f(:,OP_DRPP),g(:,OP_DZ),h(:,OP_1))
#endif
     end if
...
function v2chibb(e,f,g,h)
  ...
  case(0)
     if(surface_int) then
        ...
        temp =  &
             + intx5(e(:,:,OP_1),ri2_79,f(:,OP_DRP),g(:,OP_DR),h(:,OP_1)) &
             + intx5(e(:,:,OP_1),ri2_79,f(:,OP_DZP),g(:,OP_DZ),h(:,OP_1)) &
             - intx5(e(:,:,OP_1),ri2_79,f(:,OP_GS),g(:,OP_1),h(:,OP_DP))
     end if
...
function v3chimu(e,f,g,h)
  ...
  case(0)
     if(surface_int) then
        ...
        temp = 2.*intx3(e(:,:,OP_LP),f(:,OP_LP),h(:,OP_1 )) &
             +    intx3(e(:,:,OP_LP),f(:,OP_DZ),g(:,OP_DZ)) &
             +    intx3(e(:,:,OP_LP),f(:,OP_DR),g(:,OP_DR)) &
             +    intx3(e(:,:,OP_DZ),f(:,OP_LP),g(:,OP_DZ)) &
             +    intx3(e(:,:,OP_DR),f(:,OP_LP),g(:,OP_DR)) &
             +    intx3(e(:,:,OP_DZ),f(:,OP_DZ),g(:,OP_LP)) &
             +    intx3(e(:,:,OP_DR),f(:,OP_DR),g(:,OP_LP))
     end if
...
function v3umu(e,f,g,h)
  ...
  case(0)
     if(surface_int) then
        ...
        temp = intx4(e(:,:,OP_LP),ri_79,f(:,OP_DR),g(:,OP_DZ)) &
             - intx4(e(:,:,OP_LP),ri_79,f(:,OP_DZ),g(:,OP_DR)) &
             + intx4(e(:,:,OP_DZ),ri_79,f(:,OP_GS),g(:,OP_DR)) &
             - intx4(e(:,:,OP_DR),ri_79,f(:,OP_GS),g(:,OP_DZ)) &
             + intx4(e(:,:,OP_DZ),ri_79,f(:,OP_DR),g(:,OP_LP)) &
             - intx4(e(:,:,OP_DR),ri_79,f(:,OP_DZ),g(:,OP_LP))
     end if
...
function v3vp(e,f,g)
  ...
  case(0)
     if(surface_int) then
        ...
        temp = gam*intx4(e(:,:,OP_LP),ri2_79,f(:,OP_DP),g(:,OP_1))
     end if
...
function v3chip(e,f,g)
  ...
  case(0)
     if(surface_int) then
        ...
        temp = intx3(e(:,:,OP_LP),f(:,OP_DZ),g(:,OP_DZ)) &
             + intx3(e(:,:,OP_LP),f(:,OP_DR),g(:,OP_DR)) &
             + gam*intx3(e(:,:,OP_LP),f(:,OP_LP),g(:,OP_1))
     end if
...
function v3upsib(e,f,g,h)
  ...
  case(0)
     if(surface_int) then
        ...
        temp = temp    &
             +intx5(e(:,:,OP_DR ),ri4_79,f(:,OP_DZZP),g(:,OP_DR),h(:,OP_1)) &
             -intx5(e(:,:,OP_DZ ),ri4_79,f(:,OP_DRZP),g(:,OP_DR),h(:,OP_1)) &
             -intx5(e(:,:,OP_DRR),ri4_79,f(:,OP_DRP ),g(:,OP_DR),h(:,OP_1)) &
             -intx5(e(:,:,OP_DRZ),ri4_79,f(:,OP_DZP ),g(:,OP_DR),h(:,OP_1)) &
             +intx5(e(:,:,OP_DZ ),ri4_79,f(:,OP_DRRP),g(:,OP_DZ),h(:,OP_1)) &
             -intx5(e(:,:,OP_DR ),ri4_79,f(:,OP_DRZP),g(:,OP_DZ),h(:,OP_1)) &
             -intx5(e(:,:,OP_DZZ),ri4_79,f(:,OP_DZP ),g(:,OP_DZ),h(:,OP_1)) &
             -intx5(e(:,:,OP_DRZ),ri4_79,f(:,OP_DRP ),g(:,OP_DZ),h(:,OP_1))
        
        if(itor.eq.1) then
           temp = temp    &
                -intx5(e(:,:,OP_DR),ri5_79,f(:,OP_DRP),g(:,OP_DR),h(:,OP_1)) &
                -intx5(e(:,:,OP_DZ),ri5_79,f(:,OP_DRP),g(:,OP_DZ),h(:,OP_1))
        end if
     end if
...
function v3ubb(e,f,g,h)
  ...
  case(0)
     if(surface_int) then
        ...
        temp = intx5(e(:,:,OP_GS),ri3_79,f(:,OP_DR),g(:,OP_DZ),h(:,OP_1)) &
             - intx5(e(:,:,OP_GS),ri3_79,f(:,OP_DZ),g(:,OP_DR),h(:,OP_1))

        if(itor.eq.1) then
           temp = temp + 2.* &
                intx5(e(:,:,OP_GS),ri4_79,f(:,OP_DZ),g(:,OP_1),h(:,OP_1))
        endif
#if defined(USE3D) || defined(USECOMPLEX)
        temp = temp  &
...
!  h psi
  ...
  case(0)
     if(surface_int) then
        ...
        temp = temp  &
             +intx5(e(:,:,OP_DR ),ri2_79,f(:,OP_DP),g(:,OP_DRR),h(:,OP_DR)) &
             +intx5(e(:,:,OP_DRR),ri2_79,f(:,OP_DP),g(:,OP_DR ),h(:,OP_DR)) &
             +intx5(e(:,:,OP_DZ ),ri2_79,f(:,OP_DP),g(:,OP_DRZ),h(:,OP_DR)) &
             +intx5(e(:,:,OP_DRZ),ri2_79,f(:,OP_DP),g(:,OP_DZ ),h(:,OP_DR)) &
             +intx5(e(:,:,OP_DR ),ri2_79,f(:,OP_DP),g(:,OP_DRZ),h(:,OP_DZ)) &
             +intx5(e(:,:,OP_DRZ),ri2_79,f(:,OP_DP),g(:,OP_DR ),h(:,OP_DZ)) &
             +intx5(e(:,:,OP_DZ ),ri2_79,f(:,OP_DP),g(:,OP_DZZ),h(:,OP_DZ)) &
             +intx5(e(:,:,OP_DZZ),ri2_79,f(:,OP_DP),g(:,OP_DZ ),h(:,OP_DZ)) &
             -intx5(e(:,:,OP_DR ),ri2_79,f(:,OP_DP),g(:,OP_GS ),h(:,OP_DR)) &
             -intx5(e(:,:,OP_DZ ),ri2_79,f(:,OP_DP),g(:,OP_GS ),h(:,OP_DZ))
     end if
...
function v3vpsib(e,f,g,h)
  ...
  case(0)
     if(surface_int) then
        ...
        if(itor.eq.1) then
           temp = temp - 2.* &
                intx5(e(:,:,OP_GS),ri4_79,f(:,OP_1),g(:,OP_DZ),h(:,OP_1))
        endif
        
#if defined(USE3D) || defined(USECOMPLEX)
        temp = temp    &
             +intx5(e(:,:,OP_DZ),ri5_79,f(:,OP_DPP),g(:,OP_DR),h(:,OP_1)) &
             -intx5(e(:,:,OP_DZ),ri5_79,f(:,OP_DPP),g(:,OP_DR),h(:,OP_1)) 
#endif
     end if
...
function v3chipsipsi(e,f,g,h)
  ...
  case(0)
     if(surface_int) then
        ...
        temp = intx3(tempe,ri2_79,temp79b) &
             + intx3(tempf,ri2_79,temp79c) &
             - intx4(e(:,:,OP_DZ),ri2_79,temp79c,h(:,OP_GS)) &
             - intx4(e(:,:,OP_DR),ri2_79,temp79b,h(:,OP_GS))
     end if
...
function v3chipsib(e,f,g,h)
  ...
  case(0)
     if(surface_int) then
        ...
        temp = temp    &
             +intx5(e(:,:,OP_DZ),ri3_79,f(:,OP_DRRP),g(:,OP_DR),h(:,OP_1)) &
             +intx5(e(:,:,OP_DRZ),ri3_79,f(:,OP_DRP),g(:,OP_DR),h(:,OP_1)) &
             -intx5(e(:,:,OP_DR),ri3_79,f(:,OP_DRZP),g(:,OP_DR),h(:,OP_1)) &
             -intx5(e(:,:,OP_DRR),ri3_79,f(:,OP_DZP),g(:,OP_DR),h(:,OP_1)) &
             +intx5(e(:,:,OP_DZ),ri3_79,f(:,OP_DRZP),g(:,OP_DZ),h(:,OP_1)) &
             +intx5(e(:,:,OP_DZZ),ri3_79,f(:,OP_DRP),g(:,OP_DZ),h(:,OP_1)) &
             -intx5(e(:,:,OP_DR),ri3_79,f(:,OP_DZZP),g(:,OP_DZ),h(:,OP_1)) &
             -intx5(e(:,:,OP_DRZ),ri3_79,f(:,OP_DZP),g(:,OP_DZ),h(:,OP_1))
     
        if(itor.eq.1) then
           temp = temp    &
                -intx5(e(:,:,OP_DR),ri4_79,f(:,OP_DZP),g(:,OP_DR),h(:,OP_1)) &
                +intx5(e(:,:,OP_DZ),ri4_79,f(:,OP_DRP),g(:,OP_DR),h(:,OP_1))
        endif
     end if
...
function v3chibb(e,f,g,h)
  ...
  case(0)
     if(surface_int) then
        ...
        temp = intx5(e(:,:,OP_GS),ri2_79,f(:,OP_GS),g(:,OP_1 ),h(:,OP_1)) &
             + intx5(e(:,:,OP_GS),ri2_79,f(:,OP_DZ),g(:,OP_DZ),h(:,OP_1)) &
...
function v3uun(e,f,g,h)
  ...
  case(0)
     ...
     temp = - intx5(e(:,:,OP_DZ),ri2_79,f(:,OP_GS),g(:,OP_DZ),h(:,OP_1)) &
          ...
          -.5*intx4(e(:,:,OP_DZ),ri2_79,temp79c,h(:,OP_DZ)) &
          -.5*intx4(e(:,:,OP_DR),ri2_79,temp79c,h(:,OP_DR)) &
          -.5*intx4(e(:,:,OP_LP),ri2_79,temp79c,h(:,OP_1 ))
...
function v3vvn(e,f,g,h)
  ...
  if(itor.eq.0) then
     ...
     select case(ivform)
     case(0)
        temp = -intx5(e(:,:,OP_DR),ri3_79,f(:,OP_1),g(:,OP_1),h(:,OP_1))
     case(1)
...
function v3uchin(e,f,g,h)
  ...
  case(0)
     ...
     temp = intx4(e(:,:,OP_LP),ri_79,temp79a,h(:,OP_1 )) &
          + intx5(e(:,:,OP_DZ),ri_79,f(:,OP_GS),g(:,OP_DR),h(:,OP_1)) & 
          - intx5(e(:,:,OP_DR),ri_79,f(:,OP_GS),g(:,OP_DZ),h(:,OP_1)) & 
          + intx4(e(:,:,OP_DZ),ri_79,temp79a,h(:,OP_DZ)) & 
          + intx4(e(:,:,OP_DR),ri_79,temp79a,h(:,OP_DR))
...
function v3chichin(e,f,g,h)
  ...
  case(0)
     ...
     temp = -0.5*intx3(e(:,:,OP_DZ),temp79b,h(:,OP_DZ)) &
          -  0.5*intx3(e(:,:,OP_DR),temp79b,h(:,OP_DR)) &
          -  0.5*intx3(e(:,:,OP_LP),temp79b,h(:,OP_1))
...
function v3chis(e,f,g)
  ...
  case(0) 
     if(surface_int) then
        ...
        temp = intx3(e(:,:,OP_DZ),f(:,OP_DZ),temp79a) &
             + intx3(e(:,:,OP_DR),f(:,OP_DR),temp79a)
     end if
  ...
  case(0)
     if(surface_int) then
        ...
        if(jadv.eq.0) then
           ...
           temp = intx4(e(:,:,OP_DR),ri3_79,f(:,OP_DRZ),g(:,OP_DR )) &
                + intx4(e(:,:,OP_DR),ri3_79,f(:,OP_DZ ),g(:,OP_DRR)) &
                - intx4(e(:,:,OP_DR),ri3_79,f(:,OP_DRR),g(:,OP_DZ )) &
                - intx4(e(:,:,OP_DR),ri3_79,f(:,OP_DR ),g(:,OP_DRZ)) &
                + intx4(e(:,:,OP_DZ),ri3_79,f(:,OP_DZZ),g(:,OP_DR )) &
                + intx4(e(:,:,OP_DZ),ri3_79,f(:,OP_DZ ),g(:,OP_DRZ)) &
                - intx4(e(:,:,OP_DZ),ri3_79,f(:,OP_DRZ),g(:,OP_DZ )) &
                - intx4(e(:,:,OP_DZ),ri3_79,f(:,OP_DR ),g(:,OP_DZZ)) 
           if(itor.eq.1) then
              temp = temp &
                   - intx4(e(:,:,OP_DR),ri4_79,f(:,OP_DZ),g(:,OP_DR)) &
                   + intx4(e(:,:,OP_DR),ri4_79,f(:,OP_DR),g(:,OP_DZ)) 
           endif
        endif
     end if
    ...
    temp = 0.
     ...
     case(0)
        if(surface_int) then
           ...
           temp = intx4(e(:,:,OP_DR),ri4_79,f(:,OP_DR),g(:,OP_DP)) &
                + intx4(e(:,:,OP_DZ),ri4_79,f(:,OP_DZ),g(:,OP_DP)) &
                + intx4(e(:,:,OP_DR),ri4_79,f(:,OP_DRP),g(:,OP_1)) &
                + intx4(e(:,:,OP_DZ),ri4_79,f(:,OP_DZP),g(:,OP_1))
        end if
     case(1)
        if(surface_int) then
  ...
  if(jadv.eq.0) then
     ...
     case(0)
        if(surface_int) then
           ...
           temp = -(intx4(e(:,:,OP_DZ),ri4_79,f(:,OP_1),g(:,OP_DZP)) &
                +   intx4(e(:,:,OP_DR),ri4_79,f(:,OP_1),g(:,OP_DRP)) &
                +   intx4(e(:,:,OP_DZ),ri4_79,f(:,OP_DP),g(:,OP_DZ)) &
                +   intx4(e(:,:,OP_DR),ri4_79,f(:,OP_DP),g(:,OP_DR)))
        end if
...
function b1psichi(e,f,g)
  ...
  case(0)
     if(surface_int) then
        ...
        if(jadv.eq.0) then
           temp = -intx3(e(:,:,OP_1),f(:,OP_DZ),g(:,OP_DZ)) &
                -  intx3(e(:,:,OP_1),f(:,OP_DR),g(:,OP_DR))
        else
           temp = intx4(e(:,:,OP_DZ),ri2_79,f(:,OP_DZZ),g(:,OP_DZ )) &
                ...
                + intx4(e(:,:,OP_DR),ri2_79,f(:,OP_DRR),g(:,OP_DR )) &
  ...
  if(jadv.eq.0) then
     ...
     case(0)
        if(surface_int) then
           ...
           temp = intx4(e(:,:,OP_DZ),ri3_79,g(:,OP_DRP),f(:,OP_1))  &
                - intx4(e(:,:,OP_DR),ri3_79,g(:,OP_DZP),f(:,OP_1))  &
                + intx4(e(:,:,OP_DZ),ri3_79,g(:,OP_DR),f(:,OP_DP))  &
                - intx4(e(:,:,OP_DR),ri3_79,g(:,OP_DZ),f(:,OP_DP))
        end if
...
function b1psifd1(e,f,g,h)
  ...
  if(jadv.eq.0) then
     if(surface_int) then
        ...
        temp = intx5(e(:,:,OP_1),ri_79,f(:,OP_DZP),g(:,OP_DRP ),h(:,OP_1)) &
             - intx5(e(:,:,OP_1),ri_79,f(:,OP_DRP),g(:,OP_DZP ),h(:,OP_1))
     end if
  else
     if(surface_int) then
        temp79b = ri3_79*h(:,OP_1)
        ...
        temp = &
             - intx5(e(:,:,OP_1),temp79b,norm79(:,2),g(:,OP_DRPP),f(:,OP_GS ))&
             + intx5(e(:,:,OP_1),temp79b,norm79(:,1),g(:,OP_DZPP),f(:,OP_GS ))&
             - intx5(e(:,:,OP_1),temp79b,norm79(:,2),g(:,OP_DRP ),f(:,OP_GSP))&
             + intx5(e(:,:,OP_1),temp79b,norm79(:,1),g(:,OP_DZP ),f(:,OP_GSP))&
             - intx5(e(:,:,OP_1),temp79c,norm79(:,2),g(:,OP_DRP ),f(:,OP_GS ))&
             + intx5(e(:,:,OP_1),temp79c,norm79(:,1),g(:,OP_DZP ),f(:,OP_GS ))
     else
        temp = intx5(e(:,:,OP_GS),ri3_79,f(:,OP_DZP),g(:,OP_DRP ),h(:,OP_1)) &
             - intx5(e(:,:,OP_GS),ri3_79,f(:,OP_DRP),g(:,OP_DZP ),h(:,OP_1)) &
             + intx5(e(:,:,OP_DZ),ri3_79,f(:,OP_GSP),g(:,OP_DRP ),h(:,OP_1 )) &
             - intx5(e(:,:,OP_DR),ri3_79,f(:,OP_GSP),g(:,OP_DZP ),h(:,OP_1 )) &
             + intx5(e(:,:,OP_DZ),ri3_79,f(:,OP_GS ),g(:,OP_DRPP),h(:,OP_1 )) &
             - intx5(e(:,:,OP_DR),ri3_79,f(:,OP_GS ),g(:,OP_DZPP),h(:,OP_1 )) &
             + intx5(e(:,:,OP_DZ),ri3_79,f(:,OP_GS ),g(:,OP_DRP ),h(:,OP_DP)) &
             - intx5(e(:,:,OP_DR),ri3_79,f(:,OP_GS ),g(:,OP_DZP ),h(:,OP_DP))
     endif
  endif
  b1psifd1 = temp
#else
  ...
  if(jadv.eq.0) then
     ...
     if(surface_int) then
        ...
        temp = intx5(e(:,:,OP_1),ri3_79,temp79a,norm79(:,1),h(:,OP_DR)) &
             + intx5(e(:,:,OP_1),ri3_79,temp79a,norm79(:,2),h(:,OP_DZ)) &
             - intx5(e(:,:,OP_1),temp79b,norm79(:,1),f(:,OP_DRZ),g(:,OP_DRP ))&
             + intx5(e(:,:,OP_1),temp79b,norm79(:,1),f(:,OP_DRR),g(:,OP_DZP ))&
             - intx5(e(:,:,OP_1),temp79b,norm79(:,1),f(:,OP_DZ ),g(:,OP_DRRP))&
             + intx5(e(:,:,OP_1),temp79b,norm79(:,1),f(:,OP_DR ),g(:,OP_DRZP))&
             - intx5(e(:,:,OP_1),temp79b,norm79(:,2),f(:,OP_DZZ),g(:,OP_DRP ))&
             + intx5(e(:,:,OP_1),temp79b,norm79(:,2),f(:,OP_DRZ),g(:,OP_DZP ))&
             - intx5(e(:,:,OP_1),temp79b,norm79(:,2),f(:,OP_DZ ),g(:,OP_DRZP))&
             + intx5(e(:,:,OP_1),temp79b,norm79(:,2),f(:,OP_DR ),g(:,OP_DZZP))&
             - intx5(e(:,:,OP_DR),ri3_79,temp79a,norm79(:,1),h(:,OP_1))     &
             - intx5(e(:,:,OP_DZ),ri3_79,temp79a,norm79(:,2),h(:,OP_1))
        if(itor.eq.1) then
           temp = temp &
        ...
        temp = intx5(e(:,:,OP_GS),ri3_79,f(:,OP_DZ ),g(:,OP_DRPP),h(:,OP_1)) &
             - intx5(e(:,:,OP_GS),ri3_79,f(:,OP_DR ),g(:,OP_DZPP),h(:,OP_1))
     endif
  endif
  b1psifd2 = temp
#else
...
function b1bfd1(e,f,g,h)
  ...
  if(jadv.eq.0) then
     if(surface_int) then
        ...
        temp = intx4(e(:,:,OP_1),f(:,OP_DZ),g(:,OP_DZP),h(:,OP_1)) &
             + intx4(e(:,:,OP_1),f(:,OP_DR),g(:,OP_DRP),h(:,OP_1))
     end if
  else
     if(surface_int) then
        temp79a = f(:,OP_DZ)*g(:,OP_DZP) + f(:,OP_DR)*g(:,OP_DRP)
        ...
        temp = intx5(e(:,:,OP_GS),ri2_79,f(:,OP_DZ),g(:,OP_DZP),h(:,OP_1)) &
             + intx5(e(:,:,OP_GS),ri2_79,f(:,OP_DR),g(:,OP_DRP),h(:,OP_1))
     endif
  endif
  b1bfd1 = temp
#else
...
function b1bfd2(e,f,g,h)
  ...
  if(jadv.eq.0) then
     ...
     if(surface_int) then
        ...
        temp79c = ri4_79*h(:,OP_DP)
        temp = &
             - intx5(e(:,:,OP_1),temp79b,f(:,OP_DP),norm79(:,1),g(:,OP_DRPP)) &
             - intx5(e(:,:,OP_1),temp79b,f(:,OP_DP),norm79(:,2),g(:,OP_DZPP)) &
             - intx5(e(:,:,OP_1),temp79c,f(:,OP_1 ),norm79(:,1),g(:,OP_DRPP)) &
             - intx5(e(:,:,OP_1),temp79c,f(:,OP_1 ),norm79(:,2),g(:,OP_DZPP))

     else
#ifdef USECOMPLEX
        temp = intx5(e(:,:,OP_DZ),ri4_79,g(:,OP_DZPP),f(:,OP_DP),h(:,OP_1 ))  &
             + intx5(e(:,:,OP_DR),ri4_79,g(:,OP_DRPP),f(:,OP_DP),h(:,OP_1 ))  &
             + intx5(e(:,:,OP_DZ),ri4_79,g(:,OP_DZPP),f(:,OP_1 ),h(:,OP_DP))  &
             + intx5(e(:,:,OP_DR),ri4_79,g(:,OP_DRPP),f(:,OP_1 ),h(:,OP_DP))

        ! f''' term hack
        temp = temp + rfac* &
             (intx5(e(:,:,OP_DZ),ri4_79,g(:,OP_DZPP),f(:,OP_1),h(:,OP_1))  &
             +intx5(e(:,:,OP_DR),ri4_79,g(:,OP_DRPP),f(:,OP_1),h(:,OP_1)))
#elif defined(USE3D)
        ! here, we can integrate by parts
        temp = - &
             (intx5(e(:,:,OP_DZP),ri4_79,g(:,OP_DZPP),f(:,OP_1),h(:,OP_1))  &
             +intx5(e(:,:,OP_DRP),ri4_79,g(:,OP_DRPP),f(:,OP_1),h(:,OP_1)))
#endif
     endif
  endif
  b1bfd2 = temp
...
function b1psifn1(e,f,g,h)
  ...
  if(jadv.eq.0) then
     if(surface_int) then
        ...
        temp79a =ri_79*h(:,OP_1)*ni79(:,OP_1)**2
        temp = intx4(e(:,:,OP_1),temp79a,f(:,OP_DZP),g(:,OP_DRP )) &
             - intx4(e(:,:,OP_1),temp79a,f(:,OP_DRP),g(:,OP_DZP ))
     end if
  else
     if(surface_int) then
        temp79b = ri3_79*h(:,OP_1)*ni79(:,OP_1)**2
        ...
        temp79a = ri3_79*ni79(:,OP_1)**2
        temp = intx5(e(:,:,OP_GS),temp79a,f(:,OP_DZP),g(:,OP_DRP ),h(:,OP_1)) &
             - intx5(e(:,:,OP_GS),temp79a,f(:,OP_DRP),g(:,OP_DZP ),h(:,OP_1)) &
             + intx5(e(:,:,OP_DZ),temp79a,f(:,OP_GSP),g(:,OP_DRP ),h(:,OP_1 ))&
             - intx5(e(:,:,OP_DR),temp79a,f(:,OP_GSP),g(:,OP_DZP ),h(:,OP_1 ))&
             + intx5(e(:,:,OP_DZ),temp79a,f(:,OP_GS ),g(:,OP_DRPP),h(:,OP_1 ))&
             - intx5(e(:,:,OP_DR),temp79a,f(:,OP_GS ),g(:,OP_DZPP),h(:,OP_1 ))&
             - intx5(e(:,:,OP_DZ),temp79a,f(:,OP_GS ),g(:,OP_DRP ),h(:,OP_DP))&
             + intx5(e(:,:,OP_DR),temp79a,f(:,OP_GS ),g(:,OP_DZP ),h(:,OP_DP))
     endif
  endif
  b1psifn1 = temp
#else
...
function b1psifn2(e,f,g,h)
  ...
  if(jadv.eq.0) then
     if(surface_int) then
        ...
        temp79a = ri_79*h(:,OP_1)*ni79(:,OP_1)**2
        temp = intx4(e(:,:,OP_1),temp79a,f(:,OP_DZ ),g(:,OP_DRPP)) &
             - intx4(e(:,:,OP_1),temp79a,f(:,OP_DR ),g(:,OP_DZPP))
     end if
  else
     if(surface_int) then
        temp79a = (f(:,OP_DZ)*g(:,OP_DRP) - f(:,OP_DR)*g(:,OP_DZP)) &
        ...
        temp79a = ri3_79*ni79(:,OP_1)**2
        temp = intx5(e(:,:,OP_GS),temp79a,f(:,OP_DZ ),g(:,OP_DRPP),h(:,OP_1)) &
             - intx5(e(:,:,OP_GS),temp79a,f(:,OP_DR ),g(:,OP_DZPP),h(:,OP_1))
     endif
  endif
  b1psifn2 = temp
#else
...
#ifdef USECOMPLEX
        temp79a = ri4_79*ni79(:,OP_1)**2
        temp = intx5(e(:,:,OP_DZ),temp79a,g(:,OP_DZPP),f(:,OP_DP),h(:,OP_1 )) &
             + intx5(e(:,:,OP_DR),temp79a,g(:,OP_DRPP),f(:,OP_DP),h(:,OP_1 )) &
             - intx5(e(:,:,OP_DZ),temp79a,g(:,OP_DZPP),f(:,OP_1 ),h(:,OP_DP)) &
             - intx5(e(:,:,OP_DR),temp79a,g(:,OP_DRPP),f(:,OP_1 ),h(:,OP_DP))

        ! f''' term hack
        temp = temp + rfac* &
             (intx5(e(:,:,OP_DZ),temp79a,g(:,OP_DZPP),f(:,OP_1),h(:,OP_1))  &
             +intx5(e(:,:,OP_DR),temp79a,g(:,OP_DRPP),f(:,OP_1),h(:,OP_1)))
#elif defined(USE3D)
        temp79a = ri4_79*ni79(:,OP_1)**2
        ! here, we can integrate by parts
        temp = - &
             (intx5(e(:,:,OP_DZP),temp79a,g(:,OP_DZPP),f(:,OP_1),h(:,OP_1))  &
             +intx5(e(:,:,OP_DRP),temp79a,g(:,OP_DRPP),f(:,OP_1),h(:,OP_1)))
#endif
     endif
  endif
  b1bfn2 = temp
  ...
  if(jadv.eq.0) then
     ...
     if(surface_int) then
        if(inocurrent_norm.eq.1 .and. imulti_region.eq.0) then
           ...
           temp = -intx5(e(:,:,OP_1),ri3_79,norm79(:,1),f(:,OP_DZPP),g(:,OP_1)) &
                  +intx5(e(:,:,OP_1),ri3_79,norm79(:,2),f(:,OP_DRPP),g(:,OP_1))
        end if
     else
#ifdef USECOMPLEX
        temp = rfac*intx4(e(:,:,OP_DR),ri3_79,f(:,OP_DZPP),g(:,OP_1)) &
             - rfac*intx4(e(:,:,OP_DZ),ri3_79,f(:,OP_DRPP),g(:,OP_1))
#else
        temp = -intx4(e(:,:,OP_DRP),ri3_79,f(:,OP_DZPP),g(:,OP_1)) &
             +  intx4(e(:,:,OP_DZP),ri3_79,f(:,OP_DRPP),g(:,OP_1))
#endif
     end if
  end if
  ...
  case(0)
     if(jadv.eq.0) then
        ...
        if(surface_int) then
           ...
           temp = &
                - intx4(e(:,:,OP_GS),ri2_79,f(:,OP_DZP),g(:,OP_DZ)) &
                - intx4(e(:,:,OP_GS),ri2_79,f(:,OP_DRP),g(:,OP_DR))
        endif
     endif
  ...
  case(1)
     ...
     if(jadv.eq.0) then
        if(surface_int) then
           ...
           temp = &
                - intx4(e(:,:,OP_1),r2_79,f(:,OP_DZP),g(:,OP_DZ)) &
                - intx4(e(:,:,OP_1),r2_79,f(:,OP_DRP),g(:,OP_DR))
        endif
     else
        if(surface_int) then
           ...
           temp = intx3(e(:,:,OP_DR),temp79a,norm79(:,1)) &
                ...
                - intx4(e(:,:,OP_1),norm79(:,1),f(:,OP_DRZP),g(:,OP_DZ )) &
                - intx4(e(:,:,OP_1),norm79(:,1),f(:,OP_DRRP),g(:,OP_DR )) &
                - intx4(e(:,:,OP_1),norm79(:,1),f(:,OP_DZP ),g(:,OP_DRZ)) &
                - intx4(e(:,:,OP_1),norm79(:,1),f(:,OP_DRP ),g(:,OP_DRR)) &
                - intx4(e(:,:,OP_1),norm79(:,2),f(:,OP_DZZP),g(:,OP_DZ )) &
                - intx4(e(:,:,OP_1),norm79(:,2),f(:,OP_DRZP),g(:,OP_DR )) &
                - intx4(e(:,:,OP_1),norm79(:,2),f(:,OP_DZP ),g(:,OP_DZZ)) &
                - intx4(e(:,:,OP_1),norm79(:,2),f(:,OP_DRP ),g(:,OP_DRZ))
           if(itor.eq.1) then
              temp = temp &
           ...
           temp = &
                - intx3(e(:,:,OP_GS),f(:,OP_DZP),g(:,OP_DZ)) &
                - intx3(e(:,:,OP_GS),f(:,OP_DRP),g(:,OP_DR))
        endif
     endif
  end select
  ...
  case(1)
     if(jadv.eq.0) then
        ...
        if(surface_int) then
           ...
           temp = intx5(e(:,:,OP_1),ri_79,norm79(:,1),f(:,OP_DZPP),g(:,OP_1 ))&
                - intx5(e(:,:,OP_1),ri_79,norm79(:,2),f(:,OP_DRPP),g(:,OP_1 ))&
                + intx5(e(:,:,OP_1),ri_79,norm79(:,1),f(:,OP_DZP ),g(:,OP_DP))&
                - intx5(e(:,:,OP_1),ri_79,norm79(:,2),f(:,OP_DRP ),g(:,OP_DP))
           endif
        else
           temp = intx4(e(:,:,OP_DZ),ri_79,f(:,OP_DRPP),g(:,OP_1)) &
                - intx4(e(:,:,OP_DR),ri_79,f(:,OP_DZPP),g(:,OP_1)) &
                + intx4(e(:,:,OP_DZ),ri_79,f(:,OP_DRP ),g(:,OP_DP)) &
                - intx4(e(:,:,OP_DR),ri_79,f(:,OP_DZP ),g(:,OP_DP))
        endif
     endif
  end select
  ...
  case(0)
     if(jadv.eq.0) then
        if(surface_int) then
           ...
           temp = intx4(e(:,:,OP_1),r_79,f(:,OP_DZP),g(:,OP_DR)) &
                - intx4(e(:,:,OP_1),r_79,f(:,OP_DRP),g(:,OP_DZ))
        endif
     else
        if(surface_int) then
           temp = 0.
        else
           temp = intx4(e(:,:,OP_GS),ri_79,f(:,OP_DZP),g(:,OP_DR)) &
                - intx4(e(:,:,OP_GS),ri_79,f(:,OP_DRP),g(:,OP_DZ))
        endif
     endif
  ...
  case(1)
     ...
     if(jadv.eq.0) then
        if(surface_int) then
           ...
           temp = intx4(e(:,:,OP_1),ri_79,f(:,OP_DZP),g(:,OP_DR)) &
                - intx4(e(:,:,OP_1),ri_79,f(:,OP_DRP),g(:,OP_DZ))
        endif
     else
        if(surface_int) then
           ...
           temp = intx4(e(:,:,OP_DR),ri3_79,temp79a,norm79(:,1)) &
                ...
                + intx5(e(:,:,OP_1),ri3_79,norm79(:,1),f(:,OP_DRZP),g(:,OP_DR )) &
                - intx5(e(:,:,OP_1),ri3_79,norm79(:,1),f(:,OP_DRRP),g(:,OP_DZ )) &
                + intx5(e(:,:,OP_1),ri3_79,norm79(:,1),f(:,OP_DZP ),g(:,OP_DRR)) &
                - intx5(e(:,:,OP_1),ri3_79,norm79(:,1),f(:,OP_DRP ),g(:,OP_DRZ)) &
                + intx5(e(:,:,OP_1),ri3_79,norm79(:,2),f(:,OP_DZZP),g(:,OP_DR )) &
                - intx5(e(:,:,OP_1),ri3_79,norm79(:,2),f(:,OP_DRZP),g(:,OP_DZ )) &
                + intx5(e(:,:,OP_1),ri3_79,norm79(:,2),f(:,OP_DZP ),g(:,OP_DRZ)) &
                - intx5(e(:,:,OP_1),ri3_79,norm79(:,2),f(:,OP_DRP ),g(:,OP_DZZ))
           if(itor.eq.1) then
              temp = temp &
           ...
           temp = intx4(e(:,:,OP_GS),ri3_79,f(:,OP_DZP),g(:,OP_DR)) &
                - intx4(e(:,:,OP_GS),ri3_79,f(:,OP_DRP),g(:,OP_DZ))
        endif
     endif
  end select
  ...
  if(surface_int) then
     ...
     if(jadv.eq.0) then
        ...
        temp = temp - intx4(e(:,:,OP_DZP),ri_79,temp79a,g(:,OP_DR))   &
                    ...
                    + intx3(e(:,:,OP_DRP),temp79a,i(:,OP_DRP))        &
                    + intx3(e(:,:,OP_DZP),temp79a,i(:,OP_DZP))
#endif
     endif
...
!!$          - int4(temp79b,f(:,OP_DZ ),h(:,OP_1 ),i(:,OP_DR))
     ...
     temp = intx5(e(:,:,OP_DZ),f(:,OP_DR),temp79a,g(:,OP_DZP),h(:,OP_DZ)) &
          - intx5(e(:,:,OP_DR),f(:,OP_DZ),temp79a,g(:,OP_DZP),h(:,OP_DZ)) &
          + intx5(e(:,:,OP_DZ),f(:,OP_DR),temp79a,g(:,OP_DRP),h(:,OP_DR)) &
          - intx5(e(:,:,OP_DR),f(:,OP_DZ),temp79a,g(:,OP_DRP),h(:,OP_DR)) &
          + intx5(e(:,:,OP_DZ),f(:,OP_DR),temp79b,g(:,OP_DZP),i(:,OP_DZ)) &
          - intx5(e(:,:,OP_DR),f(:,OP_DZ),temp79b,g(:,OP_DZP),i(:,OP_DZ)) &
          + intx5(e(:,:,OP_DZ),f(:,OP_DR),temp79b,g(:,OP_DRP),i(:,OP_DR)) &
          - intx5(e(:,:,OP_DR),f(:,OP_DZ),temp79b,g(:,OP_DRP),i(:,OP_DR)) &
          + intx5(e(:,:,OP_DZ),g(:,OP_DZP),temp79a,f(:,OP_DR ),h(:,OP_DZ)) &
          + intx5(e(:,:,OP_DR),g(:,OP_DRP),temp79a,f(:,OP_DR ),h(:,OP_DZ)) &
          - intx5(e(:,:,OP_DZ),g(:,OP_DZP),temp79a,f(:,OP_DZ ),h(:,OP_DR)) &
          - intx5(e(:,:,OP_DR),g(:,OP_DRP),temp79a,f(:,OP_DZ ),h(:,OP_DR)) &
          + intx5(e(:,:,OP_DZ),g(:,OP_DZP),temp79b,f(:,OP_DR ),i(:,OP_DZ)) &
          + intx5(e(:,:,OP_DR),g(:,OP_DRP),temp79b,f(:,OP_DR ),i(:,OP_DZ)) &
          - intx5(e(:,:,OP_DZ),g(:,OP_DZP),temp79b,f(:,OP_DZ ),i(:,OP_DR)) &
          - intx5(e(:,:,OP_DR),g(:,OP_DRP),temp79b,f(:,OP_DZ ),i(:,OP_DR))
  end if
...
!!$          + int3(temp79a,h(:,OP_1 ),i(:,OP_DP))
     ...
     temp = intx5(e(:,:,OP_DZ),g(:,OP_DZP),temp79a,h(:,OP_DP),i(:,OP_1 )) &
          + intx5(e(:,:,OP_DR),g(:,OP_DRP),temp79a,h(:,OP_DP),i(:,OP_1 )) &
          + intx5(e(:,:,OP_DZ),g(:,OP_DZP),temp79a,h(:,OP_1 ),i(:,OP_DP)) &
          + intx5(e(:,:,OP_DR),g(:,OP_DRP),temp79a,h(:,OP_1 ),i(:,OP_DP)) &
...
!!$          + int4(temp79a,g(:,OP_DRP),h(:,OP_1 ),i(:,OP_DR)) 
     ...
     temp = intx5(e(:,:,OP_DZ),f(:,OP_DZP),temp79a,g(:,OP_DZP),h(:,OP_DZ)) &
          + intx5(e(:,:,OP_DR),f(:,OP_DRP),temp79a,g(:,OP_DZP),h(:,OP_DZ)) &
          + intx5(e(:,:,OP_DZ),f(:,OP_DZP),temp79a,g(:,OP_DRP),h(:,OP_DR)) &
          + intx5(e(:,:,OP_DR),f(:,OP_DRP),temp79a,g(:,OP_DRP),h(:,OP_DR)) &
          + intx5(e(:,:,OP_DZ),f(:,OP_DZP),temp79b,g(:,OP_DZP),i(:,OP_DZ)) &
          + intx5(e(:,:,OP_DR),f(:,OP_DRP),temp79b,g(:,OP_DZP),i(:,OP_DZ)) &
          + intx5(e(:,:,OP_DZ),f(:,OP_DZP),temp79b,g(:,OP_DRP),i(:,OP_DR)) &
          + intx5(e(:,:,OP_DR),f(:,OP_DRP),temp79b,g(:,OP_DRP),i(:,OP_DR)) 
  end if
...
function p1ffpnkappar(e,f,g,h,i)
  ...
  if(surface_int) then
     ...
     temp = -intx4(e(:,:,OP_DR),temp79a,f(:,OP_DRP),temp79c) &
          -  intx4(e(:,:,OP_DZ),temp79a,f(:,OP_DZP),temp79c)
  end if
...
real function energy_kth()
  ...
  select case(ivform)
  case(0)
     temp = -hypv*int4(ri2_79,vzt79(:,OP_GS),CONJUGATE(vzt79(:,OP_GS)),vis79(:,OP_1))
  case(1)
...
function tepsifkappar(e,f,g,h,j,k)
  ...
  if(surface_int) then
     ...
     temp = intx4(e(:,:,OP_1),temp79a,g(:,OP_DZP),h(:,OP_DZ)) &
          + intx4(e(:,:,OP_1),temp79a,g(:,OP_DRP),h(:,OP_DR)) &
...
function tebfkappar(e,f,g,h,j,k)
  ...
  if(surface_int) then
     ...
     temp = intx4(e(:,:,OP_DZ),g(:,OP_DZP),temp79a,h(:,OP_DP)) &
          + intx4(e(:,:,OP_DR),g(:,OP_DRP),temp79a,h(:,OP_DP)) &
...
function tebfkapparl(e,f,g,h,i,j)
  ...
  if(surface_int) then
     temp = -intx5(e(:,:,OP_1),temp79a,h(:,OP_DP),norm79(:,1),g(:,OP_DRP)) &
          -  intx5(e(:,:,OP_1),temp79a,h(:,OP_DP),norm79(:,2),g(:,OP_DZP))
  else
     ! d(temp79a)/dphi
     temp79b = ri2_79 * &
...
vectype function j1b2ipsif(e,f,g,h)
  ...
  vectype :: temp
#if defined(USE3D) || defined(USECOMPLEX)
  temp = int5(ri2_79,e(:,OP_1),f(:,OP_1),g(:,OP_DR),h(:,OP_DRPP))    &
       + int5(ri2_79,e(:,OP_1),f(:,OP_1),g(:,OP_DZ),h(:,OP_DZPP))    &
       - int5(ri2_79,e(:,OP_1),f(:,OP_1),g(:,OP_DRP),h(:,OP_DRP))    &
       - int5(ri2_79,e(:,OP_1),f(:,OP_1),g(:,OP_DZP),h(:,OP_DZP))
#else
  temp = 0
#endif
...
#if defined(USE3D) || defined(USECOMPLEX)
  temp = - int5(ri_79,e(:,OP_1),f(:,OP_1),g(:,OP_DZP),h(:,OP_DR))    &
         + int5(ri_79,e(:,OP_1),f(:,OP_1),g(:,OP_DRP),h(:,OP_DZ))
#else
  temp = 0
#endif
...
#if defined(USE3D) || defined(USECOMPLEX)
  temp = - int5(ri_79,e(:,OP_1),f(:,OP_1),g(:,OP_DZP),h(:,OP_DRPP))    &
         + int5(ri_79,e(:,OP_1),f(:,OP_1),g(:,OP_DRP),h(:,OP_DZPP))
#else
  temp = 0
#endif
