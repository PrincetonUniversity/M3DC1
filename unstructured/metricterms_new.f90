  ...
  case(1)
     ...
     if(itor.eq.1) then
        temp79a = e(:,OP_DZ)*(g(:,OP_DZ)*h(:,OP_DZ ) + g(:,OP_DR)*h(:,OP_DR)) &
             ...
             +    e(:,OP_1) *(g(:,OP_DR)*h(:,OP_DZZ) - g(:,OP_DZ)*h(:,OP_DRR))
        temp = temp &
             -2.*int3(ri2_79,f(:,OP_DP),temp79a,weight_79,79) &
             -2.*int5(ri3_79,e(:,OP_1),f(:,OP_DP),g(:,OP_DZ),h(:,OP_DR),weight_79,79)
     endif
  end select
...
vectype function v1vpsib(e,f,g,h)
  ...
  if(itor.eq.0) then
     ...
     case(1)
        ...
        if(itor.eq.1) then
           temp = temp - &
                2.*int5(ri3_79,e(:,OP_1),f(:,OP_DPP),g(:,OP_DR),h(:,OP_1),weight_79,79)
        endif
#endif
     end select
  endif
...
vectype function v2vun(e,f,g,h)
  ...
  case(1)
     ...
     if(itor.eq.1) then
        temp = temp + 2.*int4(e(:,OP_1),f(:,OP_1),g(:,OP_DZ),h(:,OP_1),weight_79,79)
     endif
  end select
...
vectype function v2vchin(e,f,g,h)
  ...
  case(1)
     temp =-int5(r2_79,e(:,OP_1),f(:,OP_DZ),g(:,OP_DZ),h(:,OP_1),weight_79,79) &
          - int5(r2_79,e(:,OP_1),f(:,OP_DR),g(:,OP_DR),h(:,OP_1),weight_79,79)

     if(itor.eq.1) then
        temp = temp - 2.*int5(r_79,e(:,OP_1),f(:,OP_1),g(:,OP_DR),h(:,OP_1),weight_79,79)
     endif
  end select
...
vectype function v3vvn(e,f,g,h)
  ...
  if(itor.eq.0) then
     ...
     case(1)
        temp = -int5(r_79,e(:,OP_DR),f(:,OP_1),g(:,OP_1),h(:,OP_1),weight_79,79)
     end select
  endif
