...
real function v1vpsib(e,f,g,h)
  ...
  if(itor.eq.0) then
     ...
     temp = 2.*(int5(ri6_79,e(:,OP_DZ),f(:,OP_DZ),g(:,OP_DR),h(:,OP_1),weight_79,79) &
...
real function v2ubsb1(e,f,g,h)
  ...
  temp79a = e(:,OP_DZ)*h(:,OP_DR) - e(:,OP_DR)*h(:,OP_DZ) &
       + ri_79*e(:,OP_1)*h(:,OP_DZ)

  temp = int4(ri3_79,temp79a,f(:,OP_DR),g(:,OP_DZ),weight_79,79) &
       - int4(ri3_79,temp79a,f(:,OP_DZ),g(:,OP_DR),weight_79,79)
...
real function v2chibsb1(e,f,g,h)
  ...
  temp79b = g(:,OP_1)*f(:,OP_GS) + g(:,OP_DZ)*f(:,OP_DZ) + g(:,OP_DR)*f(:,OP_DR)
...
real function v2vpsisb1(e,f,g,h)
  ...
  temp79b = f(:,OP_DZ)*g(:,OP_DR) - f(:,OP_DR)*g(:,OP_DZ) &
       + ri_79*f(:,OP_1)*g(:,OP_DZ)

  temp = -int3(ri4_79,temp79a,temp79b,weight_79,79)

  v2vpsisb1 = temp
  return
end function v2vpsisb1
...
real function v3umu(e,f,g,h)
  ...
  if(itor.eq.0) then
     ...
     temp = -2.* &
          ((g-2.*h)*int2(      e(:,OP_DZ),f(:,OP_LP),weight_79,79) &
...
real function v3chipsipsi(e,f,g,h)
  ...
  if(itor.eq.1) then
     temp = temp + 2.* &
          ...
          +int4(ri3_79,temp79c,e(:,OP_DZ),h(:,OP_DR ),weight_79,79) &
          +int4(ri3_79,temp79b,e(:,OP_DR),h(:,OP_DR ),weight_79,79) &
...
real function v3uun(e,f,g,h)
  ...
  if(idens.eq.0) then
     temp =-int4(r2_79,e(:,OP_DZ),f(:,OP_DZ),g(:,OP_LP),weight_79,79) &
          - int4(r2_79,e(:,OP_DR),f(:,OP_DR),g(:,OP_LP),weight_79,79) &
          + 0.5* &
          (int4(r2_79,e(:,OP_DZ),f(:,OP_DZZ),g(:,OP_DZ ),weight_79,79) &
          +int4(r2_79,e(:,OP_DZ),f(:,OP_DZ ),g(:,OP_DZZ),weight_79,79) &
          +int4(r2_79,e(:,OP_DZ),f(:,OP_DRZ),g(:,OP_DR ),weight_79,79) &
          +int4(r2_79,e(:,OP_DZ),f(:,OP_DR ),g(:,OP_DRZ),weight_79,79) &
          +int4(r2_79,e(:,OP_DR),f(:,OP_DRZ),g(:,OP_DZ ),weight_79,79) &
          +int4(r2_79,e(:,OP_DR),f(:,OP_DZ ),g(:,OP_DRZ),weight_79,79) &
          +int4(r2_79,e(:,OP_DR),f(:,OP_DRR),g(:,OP_DR ),weight_79,79) &
          +int4(r2_79,e(:,OP_DR),f(:,OP_DR ),g(:,OP_DRR),weight_79,79))
     if(itor.eq.1) then
        temp = temp &
             - 2.*int4(r_79,e(:,OP_1 ),f(:,OP_DR ),g(:,OP_LP),weight_79,79) &
             + 2.*int4(r_79,e(:,OP_1 ),f(:,OP_DRZ),g(:,OP_DZ),weight_79,79) &
             + 2.*int4(r_79,e(:,OP_1 ),f(:,OP_DRR),g(:,OP_DR),weight_79,79) &
             +    int4(r_79,e(:,OP_DR),f(:,OP_DZ), g(:,OP_DZ),weight_79,79) &
             +    int4(r_79,e(:,OP_DR),f(:,OP_DR), g(:,OP_DR),weight_79,79) &
             + 2.*int3(     e(:,OP_1 ),f(:,OP_DZ), g(:,OP_DZ),weight_79,79) &
             + 2.*int3(     e(:,OP_1 ),f(:,OP_DR), g(:,OP_DR),weight_79,79)
     endif
  else
     temp =-int5(r2_79,e(:,OP_DZ),f(:,OP_DZ),g(:,OP_LP),h(:,OP_1),weight_79,79) &
          - int5(r2_79,e(:,OP_DR),f(:,OP_DR),g(:,OP_LP),h(:,OP_1),weight_79,79) &
          + 0.5* &
          (int5(r2_79,e(:,OP_DZ),f(:,OP_DZZ),g(:,OP_DZ ),h(:,OP_1),weight_79,79) &
          +int5(r2_79,e(:,OP_DZ),f(:,OP_DZ ),g(:,OP_DZZ),h(:,OP_1),weight_79,79) &
          +int5(r2_79,e(:,OP_DZ),f(:,OP_DRZ),g(:,OP_DR ),h(:,OP_1),weight_79,79) &
          +int5(r2_79,e(:,OP_DZ),f(:,OP_DR ),g(:,OP_DRZ),h(:,OP_1),weight_79,79) &
          +int5(r2_79,e(:,OP_DR),f(:,OP_DRZ),g(:,OP_DZ ),h(:,OP_1),weight_79,79) &
          +int5(r2_79,e(:,OP_DR),f(:,OP_DZ ),g(:,OP_DRZ),h(:,OP_1),weight_79,79) &
          +int5(r2_79,e(:,OP_DR),f(:,OP_DRR),g(:,OP_DR ),h(:,OP_1),weight_79,79) &
          +int5(r2_79,e(:,OP_DR),f(:,OP_DR ),g(:,OP_DRR),h(:,OP_1),weight_79,79))
     if(itor.eq.1) then
        temp = temp &
             - 2.*int5(r_79,e(:,OP_1 ),f(:,OP_DR ),g(:,OP_LP),h(:,OP_1),weight_79,79) &
             + 2.*int5(r_79,e(:,OP_1 ),f(:,OP_DRZ),g(:,OP_DZ),h(:,OP_1),weight_79,79) &
             + 2.*int5(r_79,e(:,OP_1 ),f(:,OP_DRR),g(:,OP_DR),h(:,OP_1),weight_79,79) &
             +    int5(r_79,e(:,OP_DR),f(:,OP_DZ), g(:,OP_DZ),h(:,OP_1),weight_79,79) &
             +    int5(r_79,e(:,OP_DR),f(:,OP_DR), g(:,OP_DR),h(:,OP_1),weight_79,79) &
             + 2.*int4(     e(:,OP_1 ),f(:,OP_DZ), g(:,OP_DZ),h(:,OP_1),weight_79,79) &
             + 2.*int4(     e(:,OP_1 ),f(:,OP_DR), g(:,OP_DR),h(:,OP_1),weight_79,79)
     endif
  endif
...
real function v3uchin(e,f,g,h)
  ...
  if(idens.eq.0) then
     temp = int4(r_79,e(:,OP_DZ),f(:,OP_LP ),g(:,OP_DR ),weight_79,79) &
          - int4(r_79,e(:,OP_DR),f(:,OP_LP ),g(:,OP_DZ ),weight_79,79) &
          + int4(r_79,e(:,OP_DR),f(:,OP_DRR),g(:,OP_DZ ),weight_79,79) &
          - int4(r_79,e(:,OP_DR),f(:,OP_DRZ),g(:,OP_DR ),weight_79,79) &
          + int4(r_79,e(:,OP_DR),f(:,OP_DR ),g(:,OP_DRZ),weight_79,79) &
          - int4(r_79,e(:,OP_DR),f(:,OP_DZ ),g(:,OP_DRR),weight_79,79) &
          + int4(r_79,e(:,OP_DZ),f(:,OP_DRZ),g(:,OP_DZ ),weight_79,79) &
          - int4(r_79,e(:,OP_DZ),f(:,OP_DZZ),g(:,OP_DR ),weight_79,79) &
          + int4(r_79,e(:,OP_DZ),f(:,OP_DR ),g(:,OP_DZZ),weight_79,79) &
          - int4(r_79,e(:,OP_DZ),f(:,OP_DZ ),g(:,OP_DRZ),weight_79,79)          
     if(itor.eq.1) then
        temp = temp &
             - 2.*int3(e(:,OP_1 ),f(:,OP_LP ),g(:,OP_DZ ),weight_79,79) &
             + 2.*int3(e(:,OP_1 ),f(:,OP_DRR),g(:,OP_DZ ),weight_79,79) &
             - 2.*int3(e(:,OP_1 ),f(:,OP_DRZ),g(:,OP_DR ),weight_79,79) &
             + 2.*int3(e(:,OP_1 ),f(:,OP_DR ),g(:,OP_DRZ),weight_79,79) &
             - 2.*int3(e(:,OP_1 ),f(:,OP_DZ ),g(:,OP_DRR),weight_79,79) &
             +    int3(e(:,OP_DR),f(:,OP_DR ),g(:,OP_DZ ),weight_79,79) &
             -    int3(e(:,OP_DR),f(:,OP_DZ ),g(:,OP_DR ),weight_79,79) &
             + 2.*int4(ri_79,e(:,OP_1),f(:,OP_DR),g(:,OP_DZ),weight_79,79) &
             - 2.*int4(ri_79,e(:,OP_1),f(:,OP_DZ),g(:,OP_DR),weight_79,79)
     endif
  else
     temp = int5(r_79,e(:,OP_DZ),f(:,OP_LP ),g(:,OP_DR ),h(:,OP_1),weight_79,79) &
          - int5(r_79,e(:,OP_DR),f(:,OP_LP ),g(:,OP_DZ ),h(:,OP_1),weight_79,79) &
          + int5(r_79,e(:,OP_DR),f(:,OP_DRR),g(:,OP_DZ ),h(:,OP_1),weight_79,79) &
          - int5(r_79,e(:,OP_DR),f(:,OP_DRZ),g(:,OP_DR ),h(:,OP_1),weight_79,79) &
          + int5(r_79,e(:,OP_DR),f(:,OP_DR ),g(:,OP_DRZ),h(:,OP_1),weight_79,79) &
          - int5(r_79,e(:,OP_DR),f(:,OP_DZ ),g(:,OP_DRR),h(:,OP_1),weight_79,79) &
          + int5(r_79,e(:,OP_DZ),f(:,OP_DRZ),g(:,OP_DZ ),h(:,OP_1),weight_79,79) &
          - int5(r_79,e(:,OP_DZ),f(:,OP_DZZ),g(:,OP_DR ),h(:,OP_1),weight_79,79) &
          + int5(r_79,e(:,OP_DZ),f(:,OP_DR ),g(:,OP_DZZ),h(:,OP_1),weight_79,79) &
          - int5(r_79,e(:,OP_DZ),f(:,OP_DZ ),g(:,OP_DRZ),h(:,OP_1),weight_79,79)          
     if(itor.eq.1) then
        temp = temp &
             - 2.*int4(e(:,OP_1 ),f(:,OP_LP ),g(:,OP_DZ ),h(:,OP_1),weight_79,79) &
             + 2.*int4(e(:,OP_1 ),f(:,OP_DRR),g(:,OP_DZ ),h(:,OP_1),weight_79,79) &
             - 2.*int4(e(:,OP_1 ),f(:,OP_DRZ),g(:,OP_DR ),h(:,OP_1),weight_79,79) &
             + 2.*int4(e(:,OP_1 ),f(:,OP_DR ),g(:,OP_DRZ),h(:,OP_1),weight_79,79) &
             - 2.*int4(e(:,OP_1 ),f(:,OP_DZ ),g(:,OP_DRR),h(:,OP_1),weight_79,79) &
             +    int4(e(:,OP_DR),f(:,OP_DR ),g(:,OP_DZ ),h(:,OP_1),weight_79,79) &
             -    int4(e(:,OP_DR),f(:,OP_DZ ),g(:,OP_DR ),h(:,OP_1),weight_79,79) &
             + 2.*int5(ri_79,e(:,OP_1),f(:,OP_DR),g(:,OP_DZ),h(:,OP_1),weight_79,79) &
...
real function b2beta(e,f,g,h)
  ...
  if(h.ne.0) then
     temp79a = ri2_79*(e(:,OP_LP)*g(:,OP_1) + &
          e(:,OP_DZ)*g(:,OP_DZ) + e(:,OP_DR)*g(:,OP_DR))
     if(itor.eq.1) temp79a = temp79a - 2.*ri3_79*e(:,OP_DR)*g(:,OP_1)
...
real function b2psipsid(e,f,g,h)
  ...
  if(idens.eq.0) then
     ...
     temp = int5(ri3_79,e(:,OP_DR),f(:,OP_DZ),g(:,OP_GS),h(:,OP_1),weight_79,79) &
          - int5(ri3_79,e(:,OP_DZ),f(:,OP_DR),g(:,OP_GS),h(:,OP_1),weight_79,79)
  endif
...
real function qbbeta(e,f,g,h,i)
  ...
  if(i.ne.0) then
     temp = temp + i* &
          ...
          +2.*int5(ri2_79,e(:,OP_1),f(:,OP_DRZ),g(:,OP_DRZ),h(:,OP_1),weight_79,79) &
          -2.*int5(ri2_79,e(:,OP_1),f(:,OP_DZZ),g(:,OP_DRR),h(:,OP_1),weight_79,79))

     if(itor.eq.1) then
        temp = temp + 2.*i* &
          (int5(ri3_79,e(:,OP_1),f(:,OP_DZZ),g(:,OP_DR),h(:,OP_1),weight_79,79) &
          -int5(ri3_79,e(:,OP_1),f(:,OP_DRZ),g(:,OP_DZ),h(:,OP_1),weight_79,79) &
          +int5(ri4_79,e(:,OP_1),f(:,OP_DZ ),g(:,OP_DZ),h(:,OP_1),weight_79,79))
     endif
  endif
