FOPTS = -c -fallow-argument-mismatch -DMPICH_IGNORE_CXX_SEEK -target-accel=nvidia80 -Ofast -fPIC -cpp -DPETSC_VERSION=318 -DUSEBLAS $(OPTS)
CCOPTS  = -c -DMPICH_IGNORE_CXX_SEEK -target-accel=nvidia80 -Ofast -fPIC -DPETSC_VERSION=318 -DDEBUG
