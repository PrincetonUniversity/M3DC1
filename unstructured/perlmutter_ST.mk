...
ifeq ($(COM), 1)
  ...
  PETSC_WITH_EXTERNAL_LIB = -L${PETSC_DIR}/${PETSC_ARCH}/lib -Wl,-rpath,/global/cfs/cdirs/mp288/jinchen/PETSC/petsc.20220107/nvidia-hpc-sdk-6/lib -L/global/cfs/cdirs/mp288/jinchen/PETSC/petsc.20220107/nvidia-hpc-sdk-6/lib -L/opt/cray/pe/mpich/8.1.12/ofi/nvidia/20.7/lib -L/opt/cray/pe/libsci/21.08.1.2/NVIDIA/20.7/x86_64/lib -L/global/common/software/nersc/pm-2021q4/sw/darshan/3.3.1/lib -L/opt/cray/pe/dsmml/0.2.2/dsmml/lib -L/opt/cray/xpmem/2.2.40-2.1_3.9__g3cf3325.shasta/lib64 -L/opt/nvidia/hpc_sdk/Linux_x86_64/21.9/compilers/lib -L/usr/lib64/gcc/x86_64-suse-linux/7 -Wl,-rpath,/opt/nvidia/hpc_sdk/Linux_x86_64/21.9/compilers/lib -lpetsc -lcmumps -ldmumps -lsmumps -lzmumps -lmumps_common -lpord -lscalapack -lsuperlu -lsuperlu_dist -lflapack -lfblas -lzoltan -lparmetis -lmetis -lgsl -lgslcblas -lstdc++ -ldl -ldarshan -lz -lsci_nvidia_mpi -lsci_nvidia -lmpifort_nvidia -lmpi_nvidia -ldsmml -lxpmem -lnvf -lnvomp -lnvhpcatm -latomic -lpthread -lnvcpumath-avx2 -lnsnvc -lnvc -lrt -lm -lgcc_s -lquadmath -lstdc++ -ldl
endif
...
LIBS = 	\
	...
	-L$(NETCDF_DIR)/lib -lnetcdff -lnetcdf -lnetcdf_c++4 \
	-L$(HDF5_ROOT)/lib -lhdf5_fortran -lhdf5hl_fortran -lhdf5_hl -lhdf5 \
