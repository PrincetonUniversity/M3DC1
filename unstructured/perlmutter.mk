...
ifeq ($(ST), 1)
  LIBS += -Wl,--start-group -L/global/homes/j/jinchen/project/NETCDF/buildnvhpc/lib -Wl,-rpath,/global/homes/j/jinchen/project/NETCDF/buildnvhpc/lib -lhdf5hl_fortran -lhdf5_fortran -lhdf5_hl -lhdf5 -lnetcdf -lnetcdff -lz -Wl,--end-group -L$(FFTW_DIR) -lfftw3f_threads -lfftw3_threads -lfftw3_mpi -lfftw3f_mpi -lfftw3f -lfftw3
  INCLUDE += -I$(FFTW_INC) -I/global/cfs/cdirs/mp288/jinchen/NETCDF/buildnvhpc/include
endif
