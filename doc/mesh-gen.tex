...
\item faceBdry: A parameter to define the number of loops on a face, loop IDs, and desired mesh size. The first number gives the total number of loops bounding the face followed by the loops IDs of the bounding loops. If number of loops = $n$, there should be $n$ loop IDs. The next number after the loop IDs define the mesh size on the geometric face. 
...
numBdry 3
bdryFile loop1.dat 3 0.02
bdryFile loop2.dat 10 0.03
bdryFile loop3.dat 11 0.04
...
numFace 3
faceBdry  1 3 0.03
faceBdry  2 3 10 0.04
faceBdry  2 10 11 0.03
outFile input3
...
bdryFile loop2.dat 10 0.03
bdryFile loop3.dat 11 0.04
bdryFile loop4.dat 21 0.04
bdryFile loop5.dat 25 0.04
bdryFile loop6.dat 17 0.07
bdryFile loop7.dat 19 0.05
...
faceBdry  1 10 0.04
faceBdry  1 11 0.05
faceBdry  2 21 25 0.06
faceBdry  2 25 17 0.07
faceBdry  2 17 19 0.08
faceBdry  2 19 9 0.10
