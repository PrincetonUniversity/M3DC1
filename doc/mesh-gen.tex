...
The figure~\ref{fig:meshgen-type2} illustrates a mesh generated by the following input file.
...
The example files \texttt{poly-input} and \texttt{in-poly} can be found in 
\newline\newline
\texttt{/p/tsc/m3dc1/lib/SCORECLib/rhel7/intel2019u3-openmpi4.0.3/16.0-220226/bin}.
...
The figure~\ref{fig:meshgen-type3} illustrates a mesh generated by the following input file.
...
\caption[Mesh with inner $\&$ outer boundary points to set resistive wall]
{A mesh with inner $\&$ outer boundary points to set resistive wall}
\label{fig:meshgen-type4}
\end{figure}

The figure~\ref{fig:meshgen-type4} illustrates a mesh generated by the following input file.
