...
\begin{tabular}{llp{4in}}
  ...
  (not recommended) \\
  \texttt{ibootstrap} & 0 & 1: Using bootstrap coeeficients as a function of $\psi$; \\
                      &   & 2: Using bootstrap coeeficients as a function of $T_e$ \\
                      &   & 3: Using bootstrap coeeficients as a function of $\hat{T}=1-T_e/T_e_{max}$, coefficients are updated within M3D-C1 \\
