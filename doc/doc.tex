...
\begin{tabular}{lcp{4.0in}}
  ...
  \texttt{icurv}    & 2 & if \> 0m ubckyde curvature from mesh \\
...
\begin{tabular}{lcp{4.0in}}
  ...
  \texttt{nperiods} & 1 & number of field periods \\
...
\begin{tabular}{llp{4.5in}}
  ...
  \texttt{ntor\_rekc} & 0 & toroida mode number of REKC  \\
...
\begin{tabular}{llp{4.5in}}
  \textbf{Option}&\textbf{Default}&\textbf{Description}\\
  \hline
 \texttt{type\_ext\_field}        & 0 & 1: read either  VMEC or MGRID file \\ 
 \texttt{file\_ext\_field}        &   & (string) FIELDLINE/MGRID file.  Must start with 'fieldlines' or 'mgrid' \\
 ...
 \texttt{nperiods}                & 1 & Number of field periods (stellarator geometry).    Note nplanes
