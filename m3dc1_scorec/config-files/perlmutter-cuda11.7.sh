...
SCOREC_DIR=/global/cfs/cdirs/mp288/scorec-pmt/$MPIVER
...
cmake .. \
  ...
  -DCMAKE_C_FLAGS="-g -target-accel=nvidia80 -DPETSCMASTER -I$PETSC_DIR/include" \
  -DCMAKE_CXX_FLAGS="-g -target-accel=nvidia80 -DPETSCMASTER -I$PETSC_DIR/include" \
