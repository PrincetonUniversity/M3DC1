# These should be consistent with unstructued/cori.mk,
...
then
  PETSC_ARCH=${PETSC_ARCH:-corihsw-PrgEnvintel6010-craympich7719-master-real}
else
  PETSC_ARCH=${PETSC_ARCH:-corihsw-PrgEnvintel6010-craympich7719-master-cplx}
fi
SCOREC_BASE_DIR=${SCOREC_BASE_DIR:-/global/cfs/cdirs/mp288/jinchen/PETSC/core/upgrade-intel6610-craympich7719-hsw}
