...
/usr/bin/cmake .. \
  ...
  -DCMAKE_C_FLAGS=" -g -O3 -I$PETSC_DIR/include" \
  -DCMAKE_CXX_FLAGS=" -g -O3 -I$PETSC_DIR/include" \
  ...
  -DSTDCPP_LIBRARY="/usr/lib64/gcc/x86_64-suse-linux/4.3/libstdc++.a" \
  -DNETCDF_LIBRARY="$PARALLEL_NETCDF_DIR/lib/libpnetcdf.a" \
