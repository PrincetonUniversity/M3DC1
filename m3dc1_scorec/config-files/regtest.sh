...
cp ../mesh/part* .
$MPIRUN -n 16 ../../../$ARCH-opt-25/m3dc1_2d
git diff C1ke
rm -rf part*smb

cd $TESTDIR/KPRAD_2D/base
cp ../mesh/part* .
$MPIRUN -n 48 ../../../$ARCH-opt-25/m3dc1_2d
git diff C1ke 
rm -rf part*smb
...
$MPIRUN -n 48 ../../../$ARCH-opt-25/m3dc1_2d
git diff C1ke
rm -rf part*smb C1input

cd $TESTDIR/pellet/base
cp ../mesh/part* .
$MPIRUN -n 64 ../../../$ARCH-3d-opt-60/m3dc1_3d -ipetsc -options_file options_bjacobi.type_superludist
git diff C1ke 
rm -rf part*smb

cd $TESTDIR/RMP/base
cp ../mesh/part* .
$MPIRUN -n 16 ../../../$ARCH-complex-opt-25/m3dc1_2d_complex -pc_factor_mat_solver_type mumps
git diff C1ke 
rm -rf part*smb
