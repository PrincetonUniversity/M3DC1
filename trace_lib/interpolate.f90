...
subroutine bicubic_interpolation_coeffs(x,m,n,i,j,a)
  ...
  double precision, intent(out), dimension(4,4) :: a
...
subroutine cubic_interpolation_coeffs(x,m,i,a)
  ...
  double precision, intent(out), dimension(4) :: a
  integer :: ihermite
  double precision  :: xpi,xpip
...
subroutine cubic_interpolation(m, p, p0, f, f0)
  ...
  integer, intent(in) :: m
  double precision, intent(in), dimension(m) :: f, p
