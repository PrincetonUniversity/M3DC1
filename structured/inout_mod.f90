...
subroutine readit
  ...
  if(myrank.eq.0) then
     ...
     read(55) ((((g6aerm(iodd,i,j,k),iodd=1,2),i=1,18),j=1,18),k=1,18)
     read(55) ((((g6berm(iodd,i,j,k),iodd=1,2),i=1,18),j=1,18),k=1,18)
...
112 format(i3, "readit-2 ",1p4e12.4 )
  ...
  CALL MPI_Bcast(g6aerm,count,MPI_DOUBLE_PRECISION,root,MPI_COMM_WORLD, ier)
  CALL MPI_Bcast(g6berm,count,MPI_DOUBLE_PRECISION,root,MPI_COMM_WORLD, ier)
...
subroutine writeit
  ...
  write(55) ((((g6aerm(iodd,i,j,k),iodd=1,2),i=1,18),j=1,18),k=1,18)
  write(55) ((((g6berm(iodd,i,j,k),iodd=1,2),i=1,18),j=1,18),k=1,18)
