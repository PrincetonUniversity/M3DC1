pro momentum_x, _EXTRA=extra, nterms=nterms, terms=term, names=names, $
               title=title, x=x, z=z
  title = 'Momentum Equation: x'
  nterms = 3
...
;     jx1 = -(i1_z + f1_z*rfac^2)/r + rfac*psi1_r
     jy1 = -psi1_gs/r
     jz1 =  (i1_r + f1_r*rfac^2)/r + rfac*psi1_z
