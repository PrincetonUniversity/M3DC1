...
vectype function v1bb(e,f,g)
  ...
  case(0)
     if(itor.eq.0) then
        ...
        temp = -2.*int4(ri2_79,e(:,OP_1),f(:,OP_1),g(:,OP_DZ)) 
     endif
...
vectype function v1upsib(e,f,g,h)
  ...
  case(1)
    temp = -int3(ri_79,temp79a,h(:,OP_1))
    if(itor.eq.1) then
       temp79a = f(:,OP_DZP)*g(:,OP_DR)-f(:,OP_DRP)*g(:,OP_DZ)
       temp = temp + &
            -2.*(int5(ri2_79,e(:,OP_DZ),f(:,OP_DRP),g(:,OP_DR),h(:,OP_1)) &
                -int5(ri2_79,e(:,OP_DR),f(:,OP_DZP),g(:,OP_DR),h(:,OP_1)))
...
#ifdef USECOMPLEX
     temp = temp + &
          (int5(ri2_79,e(:,OP_DZ),f(:,OP_DZPP),g(:,OP_1),h(:,OP_1)) &
          +int5(ri2_79,e(:,OP_DR),f(:,OP_DRPP),g(:,OP_1),h(:,OP_1)))
...
vectype function v1vpsipsi(e,f,g,h)
  ...
  case(1)
     temp79a = g(:,OP_DZ)*(-h(:,OP_DZ)*e(:,OP_DRZ) - h(:,OP_DR)*e(:,OP_DRR)  &
             ...
             + g(:,OP_DR)*(-e(:,OP_DR)*h(:,OP_DRZ) - e(:,OP_DZ)*h(:,OP_DZZ)  &
                          + h(:,OP_DR)*e(:,OP_DRZ) + h(:,OP_DZ)*e(:,OP_DZZ))
     temp = int3(ri_79,f(:,OP_DP),temp79a)
     if(itor.eq.1) then

     temp = temp +  2*(int5(ri2_79,e(:,OP_DZ),f(:,OP_DP),g(:,OP_DR),h(:,OP_DR))  &
                      -int5(ri2_79,e(:,OP_DR),f(:,OP_DP),g(:,OP_DR),h(:,OP_DZ)))
...
vectype function v1vpsib(e,f,g,h)
  ...
  if(itor.eq.0) then
     ...
     select case(ivform)
     case(0)
        temp = 2.*(   int5(ri3_79,e(:,OP_DZ),f(:,OP_DZ),g(:,OP_DR),h(:,OP_1)) &
                  -   int5(ri3_79,e(:,OP_DZ),f(:,OP_DR),g(:,OP_DZ),h(:,OP_1)) &
...
#ifdef USECOMPLEX
        temp = temp - &
             (int5(ri2_79,e(:,OP_DZ),f(:,OP_DPP),g(:,OP_DZ),h(:,OP_1)) &
             +int5(ri2_79,e(:,OP_DR),f(:,OP_DPP),g(:,OP_DR),h(:,OP_1)))
#endif
     end select
  endif
...
vectype function v1vp(e,f,g)
  ...
  case(1)
     ...
     temp = 0.
#ifdef USECOMPLEX
     temp = -gam*(int4(ri2_79,e(:,OP_DZ),f(:,OP_DRP),g(:,OP_1)) &
                 -int4(ri2_79,e(:,OP_DR),f(:,OP_DZP),g(:,OP_1)) &
                 +int4(ri2_79,e(:,OP_DZ),f(:,OP_DP),g(:,OP_DR)) &
                 -int4(ri2_79,e(:,OP_DR),f(:,OP_DP),g(:,OP_DZ)))
#endif
...
vectype function v1chipsib(e,f,g,h)
  ...
  vectype :: temp
   ...
   case(1)
     ...
     temp = temp +   &
        int4(ri4_79,g(:,OP_DR),temp79a,h(:,OP_1)) &
       +int4(ri4_79,g(:,OP_DZ),temp79b,h(:,OP_1))

     if(itor.eq.1) then
        temp = temp +    &
               (int5(ri5_79,f(:,OP_DZP),e(:,OP_DR),g(:,OP_DZ),h(:,OP_1))  &
              + int5(ri5_79,f(:,OP_DRP),e(:,OP_DR),g(:,OP_DR),h(:,OP_1))  &
           -2.* int5(ri5_79,f(:,OP_DZP),e(:,OP_DZ),g(:,OP_DR),h(:,OP_1))  &
...
!-----------------start of code added 04/09/08 (scj)
     ...
     if(itor.eq.1) then
        temp = temp + 2.*int5(ri4_79,f(:,OP_DZPP),e(:,OP_1),g(:,OP_1),h(:,OP_1))
     endif
#endif
...
vectype function v1chip(e,f,g)
  ...
  case(1)
     ...
     if(itor.eq.1) then
        temp = 2.* &
             (int4(ri2_79,e(:,OP_DZ),f(:,OP_DZ),g(:,OP_DZ)) &
             +int4(ri2_79,e(:,OP_DZ),f(:,OP_DR),g(:,OP_DR)) &
             +gam*int4(ri2_79,e(:,OP_DZ),f(:,OP_GS),g(:,OP_1 )))
     end if
  end select
...
vectype function v1psisb1(e,f,g)
  ...
  temp = int4(ri_79,e(:,OP_DZ),f(:,OP_GS),g(:,OP_DR)) &
       - int4(ri_79,e(:,OP_DR),f(:,OP_GS),g(:,OP_DZ)) &
       + int4(ri_79,e(:,OP_DZ),f(:,OP_DR),g(:,OP_GS)) &
       - int4(ri_79,e(:,OP_DR),f(:,OP_DZ),g(:,OP_GS))

  if(itor.eq.1) then
     temp = temp - 2.* &
          (int4(ri2_79,e(:,OP_1),f(:,OP_GS),g(:,OP_DZ)) &
          +int4(ri2_79,e(:,OP_1),f(:,OP_DZ),g(:,OP_GS)))
  endif
...
vectype function v1bsb2(e,f,g)
  ...
  if(itor.eq.0) then 
     ...
     temp = 2.*int4(ri2_79,e(:,OP_DZ),f(:,OP_1),g(:,OP_1))
  endif
...
vectype function v2up(e,f,g)
  ...
  select case(ivform)
    ...
    case(1)
      ...
      if(itor.eq.1) then
        temp = temp - 2.*gam* int3(e(:,OP_1),f(:,OP_DZP),g(:,OP_1))
      endif
...
#ifdef USECOMPLEX
  temp = gam*int3(e(:,OP_1),f(:,OP_DPP),g(:,OP_1))
#endif
...
vectype function v2chip(e,f,g)
  ...
  temp =     int4(ri2_79,e(:,OP_1),f(:,OP_DRP),g(:,OP_DR))    &
       ...
       + gam*int4(ri2_79,e(:,OP_1),f(:,OP_DRRP),g(:,OP_1))    &
       + gam*int4(ri2_79,e(:,OP_1),f(:,OP_DZZP),g(:,OP_1))
    if(itor.eq.1) then
     temp = temp -   &
          + gam*int4(ri3_79,e(:,OP_1),f(:,OP_DRP),g(:,OP_1))
    end if
  end select
#endif
...
#ifdef USECOMPLEX
     temp = temp + &
          (int5(ri2_79,e(:,OP_1),f(:,OP_DPP),g(:,OP_DZ),h(:,OP_DZ)) &
          +int5(ri2_79,e(:,OP_1),f(:,OP_DPP),g(:,OP_DR),h(:,OP_DR)))
#endif
...
vectype function v2vpsib(e,f,g,h)
  ...
  select case(ivform)
  case(0)
     temp = int5(ri3_79,e(:,OP_1),f(:,OP_DP),g(:,OP_DR),h(:,OP_DZ)) &
          - int5(ri3_79,e(:,OP_1),f(:,OP_DP),g(:,OP_DZ),h(:,OP_DR))
  case(1)
     temp = int5(ri_79,e(:,OP_1),f(:,OP_DP),g(:,OP_DR),h(:,OP_DZ)) &
          - int5(ri_79,e(:,OP_1),f(:,OP_DP),g(:,OP_DZ),h(:,OP_DR))
  end select
  v2vpsib = -temp
#else
  v2vpsib = 0.
...
#ifdef USECOMPLEX
     temp = temp - &
          (int5(ri2_79,e(:,OP_1),f(:,OP_DZPP),g(:,OP_DZ),h(:,OP_1)) &
          +int5(ri2_79,e(:,OP_1),f(:,OP_DRPP),g(:,OP_DR),h(:,OP_1)))
#endif
...
vectype function v2ubb(e,f,g,h)
  ...
  case(1)
   temp = &
         (int5(ri_79,e(:,OP_1),f(:,OP_DRP),g(:,OP_DZ),h(:,OP_1)) &
         -int5(ri_79,e(:,OP_1),f(:,OP_DZP),g(:,OP_DR),h(:,OP_1)))
  end select
...
vectype function v2chipsipsi(e,f,g,h)
  ...
  case(1)
    temp = temp +   &
       (int5(ri4_79,f(:,OP_DRRP),e(:,OP_1),g(:,OP_DR ),h(:,OP_DR)) &
       +int5(ri4_79,f(:,OP_DRP ),e(:,OP_1),g(:,OP_DRR),h(:,OP_DR)) &
       +int5(ri4_79,f(:,OP_DRZP),e(:,OP_1),g(:,OP_DZ ),h(:,OP_DR)) &
       +int5(ri4_79,f(:,OP_DZP ),e(:,OP_1),g(:,OP_DRZ),h(:,OP_DR)) &
       +int5(ri4_79,f(:,OP_DRZP),e(:,OP_1),g(:,OP_DR ),h(:,OP_DZ)) &
       +int5(ri4_79,f(:,OP_DRP ),e(:,OP_1),g(:,OP_DRZ),h(:,OP_DZ)) &
       +int5(ri4_79,f(:,OP_DZZP),e(:,OP_1),g(:,OP_DZ ),h(:,OP_DZ)) &
       +int5(ri4_79,f(:,OP_DZP ),e(:,OP_1),g(:,OP_DZZ),h(:,OP_DZ)))
    if(itor.eq.1) then
    temp = temp - 2.*                       &
       (int5(ri5_79,f(:,OP_DRP),e(:,OP_1),g(:,OP_DR ),h(:,OP_DR)) &
       +int5(ri5_79,f(:,OP_DZP),e(:,OP_1),g(:,OP_DR ),h(:,OP_DZ)))
    endif
  end select
#endif
...
#ifdef USECOMPLEX
     temp = temp +   &
          -int5(ri5_79,f(:,OP_DZPP),e(:,OP_1),g(:,OP_DR),h(:,OP_1)) &
          +int5(ri5_79,f(:,OP_DRPP),e(:,OP_1),g(:,OP_DZ),h(:,OP_1))
#endif
...
vectype function v2vchin(e,f,g,h)
  ...
  case(1)
     ...
     if(itor.eq.1) then
        temp = temp - 2.*int5(ri_79,e(:,OP_1),f(:,OP_1),g(:,OP_DR),h(:,OP_1))
     endif
  end select
...
vectype function v3upsib(e,f,g,h)
  ...
  if(itor.eq.1) then 
     ...
     case(1)
       temp = temp    &
      + 2.*int5(ri5_79,f(:,OP_DRP),e(:,OP_DZ),g(:,OP_DZ),h(:,OP_1)) &
      - 2.*int5(ri5_79,f(:,OP_DZP),e(:,OP_DZ),g(:,OP_DR),h(:,OP_1)) &
         + int5(ri5_79,f(:,OP_DRP),e(:,OP_DR),g(:,OP_DR),h(:,OP_1)) &
         + int5(ri5_79,f(:,OP_DRP),e(:,OP_DZ),g(:,OP_DZ),h(:,OP_1))
     end select
...
!  h psi
  ...
  case(1)
  temp = temp +   &
      -int5(ri4_79,f(:,OP_DP),e(:,OP_DR ),g(:,OP_DZZ),h(:,OP_DR)) &
      +int5(ri4_79,f(:,OP_DP),e(:,OP_DRR),g(:,OP_DR ),h(:,OP_DR)) &
      +int5(ri4_79,f(:,OP_DP),e(:,OP_DZ ),g(:,OP_DRZ),h(:,OP_DR)) &
      +int5(ri4_79,f(:,OP_DP),e(:,OP_DRZ),g(:,OP_DZ ),h(:,OP_DR)) &
      +int5(ri4_79,f(:,OP_DP),e(:,OP_DR ),g(:,OP_DRZ),h(:,OP_DZ)) &
      +int5(ri4_79,f(:,OP_DP),e(:,OP_DRZ),g(:,OP_DR ),h(:,OP_DZ)) &
      -int5(ri4_79,f(:,OP_DP),e(:,OP_DZ ),g(:,OP_DRR),h(:,OP_DZ)) &
      +int5(ri4_79,f(:,OP_DP),e(:,OP_DZZ),g(:,OP_DZ ),h(:,OP_DZ))
      if(itor.eq.1) then
  temp = temp +   &
      -int5(ri5_79,f(:,OP_DP),e(:,OP_DR),g(:,OP_DR),h(:,OP_DR)) &
      -int5(ri5_79,f(:,OP_DP),e(:,OP_DZ),g(:,OP_DZ),h(:,OP_DR))
!....rewrote on 08/02/08 with some cancelations
...
vectype function v3vpsib(e,f,g,h)
  ...
  case(1)
     ...
     temp = temp    &
          +int5(ri5_79,f(:,OP_DPP),e(:,OP_DZ),g(:,OP_DR),h(:,OP_1)) &
          -int5(ri5_79,f(:,OP_DPP),e(:,OP_DR),g(:,OP_DZ),h(:,OP_1))
!.....corrected error in last line on 08/02/08
#endif
...
vectype function v3chipsib(e,f,g,h)
  ...
  case(1)
  temp = temp    &
      +int5(ri7_79,f(:,OP_DRRP),e(:,OP_DZ),g(:,OP_DR),h(:,OP_1)) &
      +int5(ri7_79,f(:,OP_DRP),e(:,OP_DRZ),g(:,OP_DR),h(:,OP_1)) &
      -int5(ri7_79,f(:,OP_DRZP),e(:,OP_DR),g(:,OP_DR),h(:,OP_1)) &
      -int5(ri7_79,f(:,OP_DZP),e(:,OP_DRR),g(:,OP_DR),h(:,OP_1)) &
      +int5(ri7_79,f(:,OP_DRZP),e(:,OP_DZ),g(:,OP_DZ),h(:,OP_1)) &
      +int5(ri7_79,f(:,OP_DRP),e(:,OP_DZZ),g(:,OP_DZ),h(:,OP_1)) &
      -int5(ri7_79,f(:,OP_DZZP),e(:,OP_DR),g(:,OP_DZ),h(:,OP_1)) &
      -int5(ri7_79,f(:,OP_DZP),e(:,OP_DRZ),g(:,OP_DZ),h(:,OP_1))

  if(itor.eq.1) then
  temp = temp    &
       - int5(ri8_79,f(:,OP_DRP),e(:,OP_DZ),g(:,OP_DR),h(:,OP_1)) &
       + int5(ri8_79,f(:,OP_DZP),e(:,OP_DR),g(:,OP_DR),h(:,OP_1)) 
  endif
  end select
#endif
  v3chipsib = temp
...
vectype function v3chibb(e,f,g,h)
  ...
  case(1)
     ...
     temp = int3(ri6_79,e(:,OP_GS),temp79a)

     if(itor.eq.1) then
        temp = temp - &
             2.*int3(ri7_79,e(:,OP_DR),temp79a)
     endif
#ifdef USECOMPLEX
     temp = temp    &
          - int5(ri8_79,e(:,OP_DR),f(:,OP_DRPP),g(:,OP_1),h(:,OP_1)) &
          - int5(ri8_79,e(:,OP_DZ),f(:,OP_DZPP),g(:,OP_1),h(:,OP_1))
#endif
...
!        temp = (int4(ri_79,e(:,OP_DR),f(:,OP_DRZ),g(:,OP_DR )) &
!              + int4(ri_79,e(:,OP_DR),f(:,OP_DZ ),g(:,OP_DRR)) &
!              - int4(ri_79,e(:,OP_DR),f(:,OP_DRR),g(:,OP_DZ )) &
!              - int4(ri_79,e(:,OP_DR),f(:,OP_DR ),g(:,OP_DRZ)) &
!              + int4(ri_79,e(:,OP_DZ),f(:,OP_DZZ),g(:,OP_DR )) &
!              + int4(ri_79,e(:,OP_DZ),f(:,OP_DZ ),g(:,OP_DRZ)) &
!              - int4(ri_79,e(:,OP_DZ),f(:,OP_DRZ),g(:,OP_DZ )) &
!              - int4(ri_79,e(:,OP_DZ),f(:,OP_DR ),g(:,OP_DZZ)))
!        if(itor.eq.1) then
!           temp = temp &
!                + (int4(ri2_79,e(:,OP_DR),f(:,OP_DZ),g(:,OP_DR)) &
!                - int4(ri2_79,e(:,OP_DR),f(:,OP_DR),g(:,OP_DZ)))
!        endif
...
vectype function b1psiv(e,f,g)
  ...
  if(jadv.eq.0) then
    ...
    case(1)
       temp = int4(ri2_79,e(:,OP_DR),f(:,OP_DR),g(:,OP_DP)) &
...
vectype function b1psichi(e,f,g)
  ...
  case(1)
     if(jadv.eq.0) then
        ...
        if(itor.eq.1) then
          temp = temp +    &
            -2.*int4(ri5_79,e(:,OP_DR),f(:,OP_DR),g(:,OP_DR)) &
            -2.*int4(ri5_79,e(:,OP_DR),f(:,OP_DZ),g(:,OP_DZ))
        endif
     endif
...
vectype function b1bchi(e,f,g)
  ...
  if(jadv.eq.0) then
     ...
     case(0)
     temp =  &
       int4(ri3_79,e(:,OP_DZ),g(:,OP_DRP),f(:,OP_1))  &
     - int4(ri3_79,e(:,OP_DR),g(:,OP_DZP),f(:,OP_1))
     case(1)
     temp =  &
       int4(ri5_79,e(:,OP_DZ),g(:,OP_DRP),f(:,OP_1))  &
...
vectype function b1psipsid(e,f,g,h)
  ...
  if(jadv.eq.0) then
    temp = 0.
     ...
     temp = -0.5*int3(ri4_79,temp79a,h(:,OP_1)) &
...
vectype function b1psibd(e,f,g,h)
  ...
  if(jadv.eq.0) then
     ...
     temp79c = f(:,OP_DZZ)*g(:,OP_DR ) - f(:,OP_DRZ)*g(:,OP_DZ ) &
             + f(:,OP_DZ )*g(:,OP_DRZ) - f(:,OP_DR )*g(:,OP_DZZ)
     temp = -int4(ri3_79,e(:,OP_DZ),temp79c,h(:,OP_1 )) &
          -  int4(ri3_79,e(:,OP_DR),temp79b,h(:,OP_1 )) &
          -  int4(ri3_79,temp79a,e(:,OP_DZ),h(:,OP_DZ)) &
          -  int4(ri3_79,temp79a,e(:,OP_DR),h(:,OP_DR))
     if(itor.eq.1) then
        temp = temp + int4(ri4_79,e(:,OP_DR),temp79a,h(:,OP_1 ))
     endif
  endif
#ifdef USECOMPLEX
  if(jadv.eq.0) then
...
vectype function b1ped(e,f,g)
  ...
  if(jadv.eq.0) then
    ...
    temp = int4(ri2_79,e(:,OP_DR),f(:,OP_DP),g(:,OP_DR)) &
...
vectype function b2psieta(e,f,g,h)
  ...
  select case (ibform)
  case(0)
  temp = int4(ri_79,e(:,OP_DZ),f(:,OP_DRP),g(:,OP_1)) &
       - int4(ri_79,e(:,OP_DR),f(:,OP_DZP),g(:,OP_1))
  if(itor.eq.1) then
     temp = temp - 2.* &
          int4(ri2_79,e(:,OP_1),f(:,OP_DZP),g(:,OP_1))
  endif
  ...
  if(hypi.ne.0.) then
     ...
     temp = temp  &
          + int5(ri_79,e(:,OP_DZ),temp79a,g(:,OP_1 ),h(:,OP_DR)) &
          - int5(ri_79,e(:,OP_DR),temp79a,g(:,OP_1 ),h(:,OP_DZ)) &
          + int5(ri_79,e(:,OP_DZ),temp79a,g(:,OP_DR),h(:,OP_1 )) &
          - int5(ri_79,e(:,OP_DR),temp79a,g(:,OP_DZ),h(:,OP_1 ))

     if(itor.eq.1) then
        temp = temp - 2.* &
             (int5(ri2_79,e(:,OP_1),temp79a,g(:,OP_1 ),h(:,OP_DZ)) &
             +int5(ri2_79,e(:,OP_1),temp79a,g(:,OP_DZ),h(:,OP_1 )))
     endif
  endif
  case(1)
  temp = int4(ri3_79,e(:,OP_DZ),f(:,OP_DRP),g(:,OP_1)) &
...
vectype function b2beta(e,f,g,h)
  ...
  select case(ibform)
  case(0)
     temp = -int3(e(:,OP_DZ),f(:,OP_DZ),g(:,OP_1)) &
          -  int3(e(:,OP_DR),f(:,OP_DR),g(:,OP_1))

     if(itor.eq.1) then
        temp = temp - &
             2.*int4(ri_79,e(:,OP_1),f(:,OP_DR),g(:,OP_1))
     end if
...
#ifdef USECOMPLEX
        temp = temp + &
             (int4(e(:,OP_DZ),f(:,OP_DZPP),g(:,OP_1),h(:,OP_1)) &
             +int4(e(:,OP_DR),f(:,OP_DRPP),g(:,OP_1),h(:,OP_1)))
        if(itor.eq.1) then
           temp = temp + 2.* &
                (int5(ri_79,e(:,OP_1 ),f(:,OP_DRPP),g(:,OP_1),h(:,OP_1)) &
                -int5(ri_79,e(:,OP_DR),f(:,OP_DPP ),g(:,OP_1),h(:,OP_1)) &
                -2.*int5(ri2_79,e(:,OP_1),f(:,OP_DPP),g(:,OP_1),h(:,OP_1)))
  ...
  case(1)
     ...
     if(hypi.ne.0.) then
        if(ihypeta.eq.1) then
           ...
           temp = temp - int4(ri2_79,e(:,OP_GS),f(:,OP_GS),h(:,OP_1))
        end if
     endif
...
vectype function b2bu(e,f,g)
  ...
  case(0)
     ...
     case(0)
        ...
        if(itor.eq.1) then
           temp = temp - 2.*int4(ri2_79,e(:,OP_1),f(:,OP_1),g(:,OP_DZ))
        endif
     case(1)
        temp = (int4(r_79,e(:,OP_1),f(:,OP_DR),g(:,OP_DZ)) &
              - int4(r_79,e(:,OP_1),f(:,OP_DZ),g(:,OP_DR)))
...
!!$        temp = int4(ri3_79,e(:,OP_1),f(:,OP_DR),g(:,OP_DZ)) &
!!$             - int4(ri3_79,e(:,OP_1),f(:,OP_DZ),g(:,OP_DR))
!!$        if(itor.eq.1) then
!!$           temp = temp - 2.*int4(ri4_79,e(:,OP_1),f(:,OP_1),g(:,OP_DZ))
!!$        endif
...
vectype function b2bchi(e,f,g)
  ...
  case(0)
     ...
     if(itor.eq.1) then
        temp = temp + 2.*int4(ri3_79,e(:,OP_1),f(:,OP_1),g(:,OP_DR))
     endif
  ...
  case(0)
     ...
     case(0)
        temp = int4(ri_79,e(:,OP_1),f(:,OP_DR),g(:,OP_DZ)) &
             - int4(ri_79,e(:,OP_1),f(:,OP_DZ),g(:,OP_DR))
        if(itor.eq.1) then
           temp = temp + 2.*int4(ri2_79,e(:,OP_1),f(:,OP_DZ),g(:,OP_1))
        endif
     case(1)
        temp = int4(r_79,e(:,OP_1),f(:,OP_DR),g(:,OP_DZ)) &
             - int4(r_79,e(:,OP_1),f(:,OP_DZ),g(:,OP_DR))
...
vectype function b2psipsid(e,f,g,h)
  ...
  case(0)
     ...
     if(itor.eq.1) then
        temp = temp + 2.* &
             int5(ri2_79,e(:,OP_1),f(:,OP_GS),g(:,OP_DZ),h(:,OP_1))
     endif
...
vectype function b2psibd(e,f,g,h)
  ...
  case(0)
     temp = &
          -(int5(ri2_79,e(:,OP_DZ),f(:,OP_DZP),g(:,OP_1),h(:,OP_1)) &
           +int5(ri2_79,e(:,OP_DR),f(:,OP_DRP),g(:,OP_1),h(:,OP_1)))
     if(itor.eq.1) temp = temp &
          - 2.*int5(ri3_79,e(:,OP_1),f(:,OP_DRP),g(:,OP_1),h(:,OP_1))
...
vectype function b2bbd(e,f,g,h)
  ...
  select case(ibform)
  case(0)
     temp = int5(ri_79,e(:,OP_1),f(:,OP_1),g(:,OP_DR),h(:,OP_DZ)) &
...
#ifdef USECOMPLEX
  temp = int3(e(:,OP_DZ),f(:,OP_GS),g(:,OP_DZP)) &
       + int3(e(:,OP_DR),f(:,OP_GS),g(:,OP_DRP))
...
#ifdef USECOMPLEX
  temp = - &
       (int4(ri3_79,e(:,OP_DZ),f(:,OP_1),g(:,OP_DRPP)) &
       -int4(ri3_79,e(:,OP_DR),f(:,OP_1),g(:,OP_DZPP)))

  if(itor.eq.1) then
     temp = temp + 2.* &
          int4(ri4_79,e(:,OP_1),f(:,OP_1),g(:,OP_DZPP))
  endif
...
vectype function g1u(e,f)
  ...
  case(1)
     ...
     temp79a = 0.5*r_79*(5.-3.*ri2_79*b2i79(:,OP_1)*bzt79(:,OP_1)**2) * &
          (f(:,OP_DRZ)*temp79b - e(:,OP_DRZ)*temp79c)

     if(itor.eq.1) then
        temp79a = temp79a &
             + 0.5*(1.+3.*ri2_79*b2i79(:,OP_1)*pst79(:,OP_DR)**2) * &
               (f(:,OP_DZ)*temp79b - e(:,OP_DZ)*temp79c) &
             + 3.*ri2_79*b2i79(:,OP_1)*pst79(:,OP_DZ)*pst79(:,OP_DR) * &
               (e(:,OP_DZ)*f(:,OP_DRZ) - f(:,OP_DZ)*e(:,OP_DRZ))
     endif
     
     temp79a = -temp79a*bzt79(:,OP_1)*b2i79(:,OP_1)
...
vectype function g1v(e,f)
  ...
  case(1)
     ...
     temp79b = (f(:,OP_DZ)*e(:,OP_DZZ)                 &
               +f(:,OP_DR)*e(:,OP_DRZ))*pst79(:,OP_DR) &
             - (f(:,OP_DZ)*e(:,OP_DRZ)                 &
               +f(:,OP_DR)*e(:,OP_DRR))*pst79(:,OP_DZ)
     if(itor.eq.1) then
        temp79b = temp79b + ri_79*pst79(:,OP_DR)* &
             (e(:,OP_DZ)*f(:,OP_DR) - e(:,OP_DR)*f(:,OP_DZ))
     endif

     temp79c = e(:,OP_DZZ)*pst79(:,OP_DZ)**2 &
          +    e(:,OP_DRR)*pst79(:,OP_DR)**2 &
          + 2.*e(:,OP_DRZ)*pst79(:,OP_DR)*pst79(:,OP_DZ)
     if(itor.eq.1) then
        temp79c = temp79c + ri_79*pst79(:,OP_DZ)* &
             (e(:,OP_DZ)*pst79(:,OP_DR) - e(:,OP_DR)*pst79(:,OP_DZ))
     endif
     
     temp79a = 1.5*ri_79*b2i79(:,OP_1)* &
          (temp79b*(pst79(:,OP_DZ)**2 + pst79(:,OP_DR)**2) &
          +temp79c*(pst79(:,OP_DZ)*f(:,OP_DR) - pst79(:,OP_DR)*f(:,OP_DZ))) &
          - 0.5*r_79* &
          (2.*e(:,OP_DRZ)*(f(:,OP_DR)*pst79(:,OP_DR)  &
                         - f(:,OP_DZ)*pst79(:,OP_DZ)) &
          +(e(:,OP_DZZ) - e(:,OP_DRR))*(f(:,OP_DR)*pst79(:,OP_DZ)  &
                                      + f(:,OP_DZ)*pst79(:,OP_DR)))

     if(itor.eq.1) then
        temp79a = temp79a - 0.5* &
             (e(:,OP_DZ)*(3.*f(:,OP_DR)*pst79(:,OP_DR)  &
                         +   f(:,OP_DZ)*pst79(:,OP_DZ)) &
             -e(:,OP_DR)*(f(:,OP_DZ)*pst79(:,OP_DR) &
                        + f(:,OP_DR)*pst79(:,OP_DZ)))
     endif

     temp79a = temp79a*b2i79(:,OP_1)
...
vectype function g1chi(e,f)
  ...
  case(1)
     ...
     if(itor.eq.1) temp79b = temp79b -     ri_79*e(:,OP_DR)
     temp79c = e(:,OP_DRZ)
     if(itor.eq.1) temp79c = temp79c - 0.5*ri_79*e(:,OP_DZ)
     temp79d = f(:,OP_DZZ) - f(:,OP_DRR)
     if(itor.eq.1) temp79d = temp79d + 2.0*ri_79*f(:,OP_DR)
     temp79e = f(:,OP_DRZ)
     if(itor.eq.1) temp79e = temp79e -     ri_79*f(:,OP_DZ)
     
     temp79a = 2.*temp79c*temp79e + 0.5*temp79b*temp79d + &
          3.*ri2_79*b2i79(:,OP_1)* &
          (0.5*temp79b*(f(:,OP_DZZ)*pst79(:,OP_DR)**2 &
                       -f(:,OP_DRR)*pst79(:,OP_DZ)**2) &
           +(pst79(:,OP_DZ)**2 + pst79(:,OP_DR)**2)*temp79c*temp79e &
           -pst79(:,OP_DZ)*pst79(:,OP_DR)*temp79c*f(:,OP_GS))
     

     if(itor.eq.1) then
        temp79a = temp79a + 3.*ri3_79*b2i79(:,OP_1)* &
             (2.0*f(:,OP_DR)*temp79b*pst79(:,OP_DZ)**2 &
             +3.0*f(:,OP_DR)*temp79c*pst79(:,OP_DZ)*pst79(:,OP_DR) &
             -0.5*f(:,OP_DR)*temp79b*(pst79(:,OP_DZ)**2 + pst79(:,OP_DR)**2) &
             +0.5*e(:,OP_DZ)*temp79d*pst79(:,OP_DZ)*pst79(:,OP_DR) &
             +0.5*e(:,OP_DZ)*temp79e*(pst79(:,OP_DZ)**2 - pst79(:,OP_DR)**2))
     end if

     temp79a = -temp79a*ri2_79*bzt79(:,OP_1)*b2i79(:,OP_1)
...
vectype function g2u(e,f)
  ...
  case(1)
     ...
     temp79b = 2.*e(:,OP_DZ)*f(:,OP_DRZ) &
          - e(:,OP_DR)*(f(:,OP_DZZ) - f(:,OP_DRR))
     temp79c = 2.*e(:,OP_DR)*f(:,OP_DRZ) &
          + e(:,OP_DZ)*(f(:,OP_DZZ) - f(:,OP_DRR))
     temp79d = pst79(:,OP_DZ)*pst79(:,OP_DR)*(f(:,OP_DZZ) - f(:,OP_DRR)) &
          - (pst79(:,OP_DZ)**2 - pst79(:,OP_DR)**2)*f(:,OP_DRZ)
     if(itor.eq.1) then
        temp79b = temp79b + ri_79* &
             (e(:,OP_DR)*f(:,OP_DR) - e(:,OP_DZ)*f(:,OP_DZ))
        temp79c = temp79c - ri_79* &
             (e(:,OP_DZ)*f(:,OP_DR) - 3.*e(:,OP_DR)*f(:,OP_DZ))
        temp79d = temp79d + ri_79* &
             (-pst79(:,OP_DZ)*pst79(:,OP_DR)*f(:,OP_DR) &
             +(pst79(:,OP_DZ)**2 +2.* pst79(:,OP_DR)**2)*f(:,OP_DZ))
     end if

     temp79a = r_79*(1.-1.5*ri2_79*b2i79(:,OP_1)*bzt79(:,OP_1)**2) * &
          (pst79(:,OP_DZ)*temp79b - pst79(:,OP_DR)*temp79c) &
          + 1.5*ri_79*b2i79(:,OP_1)*temp79d * &
          (e(:,OP_DZ)*pst79(:,OP_DZ) + e(:,OP_DR)*pst79(:,OP_DR))
...
!!$          (pst79(:,OP_DZ)**2 + pst79(:,OP_DR)**2 - bzt79(:,OP_1)**2))
  ...
  case(1)
     ...
     temp79a = 0.5*r_79*b2i79(:,OP_1)*bzt79(:,OP_1)*temp79b* &
          (1.-3.*ri2_79*b2i79(:,OP_1)*bzt79(:,OP_1)**2)
  end select
     ...
     temp79a = &
          ...
          -1.5*ri2_79*b2i79(:,OP_1)**2*bzt79(:,OP_1)**2 * &
           ...
           -f(:,OP_DRZ)*(e(:,OP_DR)*pst79(:,OP_DZ) + &
                         e(:,OP_DZ)*pst79(:,OP_DR)))
  case(1)
     temp79b = pst79(:,OP_DZ)*f(:,OP_DZZ)+pst79(:,OP_DR)*f(:,OP_DRZ)
     temp79c = pst79(:,OP_DZ)*f(:,OP_DRZ)+pst79(:,OP_DR)*f(:,OP_DRR)
     temp79d = f(:,OP_GS)
     temp79e = f(:,OP_DZZ) - f(:,OP_DRR)
     temp79f = f(:,OP_DRZ)
     if(itor.eq.1) then
        temp79b = temp79b - ri_79 * &
             (pst79(:,OP_DZ)*f(:,OP_DR) + pst79(:,OP_DR)*f(:,OP_DZ))
        temp79c = temp79c - ri_79 * &
             (pst79(:,OP_DZ)*f(:,OP_DZ) + 3.*pst79(:,OP_DR)*f(:,OP_DR))
        temp79d = temp79d - ri_79 * 3.*f(:,OP_DR)
        temp79e = temp79e + ri_79 * 2.*f(:,OP_DR)
        temp79f = temp79f - ri_79 *    f(:,OP_DZ)
     endif

     temp79a = ri2_79*(1.-3.*ri2_79*b2i79(:,OP_1)*bzt79(:,OP_1)**2) * &
          (e(:,OP_DZ)*temp79b - e(:,OP_DR)*temp79c) &
          + 3.*ri4_79*b2i79(:,OP_1)* &
          (temp79d*bzt79(:,OP_1)**2 * &
           (e(:,OP_DZ)*pst79(:,OP_DZ) + e(:,OP_DR)*pst79(:,OP_DR)) &
          +(e(:,OP_DZ)*pst79(:,OP_DR) - e(:,OP_DZ)*pst79(:,OP_DR)) &
           *(temp79e*pst79(:,OP_DZ)*pst79(:,OP_DR) &
            -temp79f*(pst79(:,OP_DZ)**2 - pst79(:,OP_DR)**2)))

     temp79a = 0.5*temp79a*b2i79(:,OP_1)
  end select
...
vectype function g3u(e,f)
  ...
  case(1)
     ...
     if(itor.eq.1) temp79c = temp79c + 0.5*ri_79*f(:,OP_DZ)
     temp79d = e(:,OP_DRR)
     if(itor.eq.1) temp79d = temp79d - 3.0*ri_79*e(:,OP_DR)
     temp79e = e(:,OP_DZZ)
     if(itor.eq.1) temp79e = temp79e -     ri_79*e(:,OP_DR)
     temp79f = f(:,OP_DZZ) - f(:,OP_DRR)
     if(itor.eq.1) temp79f = temp79f -     ri_79*f(:,OP_DR)

     temp79a = bzt79(:,OP_1)* &
          (-4.*temp79b*temp79c - temp79f*(temp79e-temp79d) &
           +6.*ri2_79*b2i79(:,OP_1)*(pst79(:,OP_DR)**2 + pst79(:,OP_DZ)**2)*temp79b*temp79c) &
           +3.*ri2_79*b2i79(:,OP_1)* &
           ((temp79d*pst79(:,OP_DZ)**2 - temp79e*pst79(:,OP_DR)**2)*temp79f &
           +2.*pst79(:,OP_DZ)*pst79(:,OP_DR)*(2.*temp79c - f(:,OP_DRZ))*(temp79e-temp79d))
     if(itor.eq.1) then
        temp79a = temp79a + bzt79(:,OP_1)*3.*ri2_79*b2i79(:,OP_1)*f(:,OP_DZ) * &
             ((pst79(:,OP_DZ)**2 - pst79(:,OP_DR)**2)*temp79b &
             -2.*pst79(:,OP_DZ)*pst79(:,OP_DR)*temp79e)
     endif

     temp79a = 0.5*temp79a*ri2_79*b2i79(:,OP_1)
...
vectype function g3v(e,f)
  ...
  case(1)
     ...
     temp79b = pst79(:,OP_DZ)*(e(:,OP_DZZ)*f(:,OP_DZ)  &
                              +e(:,OP_DRZ)*f(:,OP_DR)) &
              +pst79(:,OP_DR)*(e(:,OP_DRZ)*f(:,OP_DZ)  &
                              +e(:,OP_DRR)*f(:,OP_DR))

     temp79c = bzt79(:,OP_1)**2 * e(:,OP_GS) - &
          (pst79(:,OP_DZ)**2*e(:,OP_DZZ) &
          +pst79(:,OP_DR)**2*e(:,OP_DRR) &
          +2.*pst79(:,OP_DZ)*pst79(:,OP_DR)*e(:,OP_DRZ))
     ...
     if(itor.eq.1) then
        temp79b = temp79b - ri_79* &
            (pst79(:,OP_DZ)* &
             (e(:,OP_DR)*f(:,OP_DZ) +    e(:,OP_DZ)*f(:,OP_DR)) &
            +pst79(:,OP_DR)* &
             (e(:,OP_DZ)*f(:,OP_DZ) + 3.*e(:,OP_DR)*f(:,OP_DR)))

        temp79c = temp79c - ri_79* &
             (3.*bzt79(:,OP_1)**2 *e(:,OP_DR) &
             -   pst79(:,OP_DZ)**2*e(:,OP_DR) &
             -3.*pst79(:,OP_DR)**2*e(:,OP_DR) &
             -2.*pst79(:,OP_DZ)*pst79(:,OP_DR)*e(:,OP_DZ))
     end if

     temp79a = ri2_79*b2i79(:,OP_1) * &
          (2.*(1.-1.5*ri2_79*b2i79(:,OP_1)*bzt79(:,OP_1)**2)*temp79b &
          +1.5*ri2_79*b2i79(:,OP_1)*temp79c * &
          (pst79(:,OP_DZ)*f(:,OP_DZ) + pst79(:,OP_DR)*f(:,OP_DR)))
...
vectype function g3chi(e,f)
  ...
  case(1)
     temp79b = pst79(:,OP_DZ)*f(:,OP_DZZ) &
          +    pst79(:,OP_DR)*f(:,OP_DRZ)
     temp79c = pst79(:,OP_DZ)*f(:,OP_DRZ) &
          +    pst79(:,OP_DR)*f(:,OP_DRR)
     temp79d = f(:,OP_GS)
     temp79e = f(:,OP_DZZ) - f(:,OP_DRR)
     temp79f = f(:,OP_DRZ)
     ...
     if(itor.eq.1) then
        ...
        temp79c = temp79c - ri_79* &
             (   pst79(:,OP_DZ)*f(:,OP_DZ) &
             +3.*pst79(:,OP_DR)*f(:,OP_DR))
        temp79d = temp79d - 3.*ri_79*f(:,OP_DR)
        temp79e = temp79e + 2.*ri_79*f(:,OP_DR)
        temp79f = temp79f -    ri_79*f(:,OP_DR)
     end if
     ...
     temp79a = ri2_79*(1.-3.*ri2_79*b2i79(:,OP_1)*bzt79(:,OP_1)**2) * &
          ...
          (temp79d*bzt79(:,OP_1)**2 * &
           (e(:,OP_DZ)*pst79(:,OP_DZ) + e(:,OP_DR)*pst79(:,OP_DR)) &
          +(e(:,OP_DZ)*pst79(:,OP_DR) - e(:,OP_DR)*pst79(:,OP_DZ)) * &
          (pst79(:,OP_DR)*pst79(:,OP_DZ)*temp79e &
          +(pst79(:,OP_DZ)**2 - pst79(:,OP_DR)**2)*temp79f))
...
real function flux_pressure()
  ...
  case(1)
     temp79a = ri2_79*(pt79(:,OP_1)*cht79(:,OP_GS) &
          + pt79(:,OP_DZ)*cht79(:,OP_DZ) + pt79(:,OP_DR)*cht79(:,OP_DR)) &
          + r_79* &
          ( pt79(:,OP_DZ)*pht79(:,OP_DR) - pt79(:,OP_DR)*pht79(:,OP_DZ))
  ...
  flux_pressure = real(-gam/(gam-1.)*int1(temp79a))
  return
...
real function flux_ke()
  ...
  temp = temp + int2(nt79(:,OP_1),temp79c)
...
! MISSING HYPER-RESISTIVE TERMS
  ...
  flux_poynting = real(-int1(temp79a))
  return
...
real function flux_heat()
  ...
  if(kappar.ne.0.) then
     ...
     temp = temp &
          + int3(ri2_79,temp79b,temp79c) &
          + int4(kar79(:,OP_1),ri2_79,b2i79(:,OP_1),temp79d)
  endif
...
vectype function torque_em()
  ...
  temp = int3(ri_79,bzt79(:,OP_DZ),pst79(:,OP_DR)) &
       - int3(ri_79,bzt79(:,OP_DR),pst79(:,OP_DZ))
...
vectype function torque_sol()
  ...
  select case(ivform)
  case(0)
     temp = int4(ri_79,pht79(:,OP_DZ),vzt79(:,OP_DR),nt79(:,OP_1 )) &
          - int4(ri_79,pht79(:,OP_DR),vzt79(:,OP_DZ),nt79(:,OP_1 )) &
          + int4(ri_79,pht79(:,OP_DZ),vzt79(:,OP_1 ),nt79(:,OP_DR)) &
          - int4(ri_79,pht79(:,OP_DR),vzt79(:,OP_1 ),nt79(:,OP_DZ))
  case(1)
     temp = int4(r_79,pht79(:,OP_DZ),vzt79(:,OP_DR),nt79(:,OP_1 )) &
          - int4(r_79,pht79(:,OP_DR),vzt79(:,OP_DZ),nt79(:,OP_1 )) &
          + int4(r_79,pht79(:,OP_DZ),vzt79(:,OP_1 ),nt79(:,OP_DR)) &
          - int4(r_79,pht79(:,OP_DR),vzt79(:,OP_1 ),nt79(:,OP_DZ))
     if(itor.eq.1) then
        temp = temp + 2.* &
             int3(pht79(:,OP_DZ),vzt79(:,OP_1),nt79(:,OP_1))
     end if
  end select
...
vectype function torque_com()
  ...
  select case(ivform)
  case(0)
     temp = int3(cht79(:,OP_DZ),vzt79(:,OP_DZ),nt79(:,OP_1 )) &
          + int3(cht79(:,OP_DR),vzt79(:,OP_DR),nt79(:,OP_1 )) &
          + int3(cht79(:,OP_DZ),vzt79(:,OP_1 ),nt79(:,OP_DZ)) &
          + int3(cht79(:,OP_DR),vzt79(:,OP_1 ),nt79(:,OP_DR)) &
          + int3(cht79(:,OP_LP),vzt79(:,OP_1 ),nt79(:,OP_1 ))
  case(1)
     temp = int4(r2_79,cht79(:,OP_DZ),vzt79(:,OP_DZ),nt79(:,OP_1 )) &
          + int4(r2_79,cht79(:,OP_DR),vzt79(:,OP_DR),nt79(:,OP_1 )) &
          + int4(r2_79,cht79(:,OP_DZ),vzt79(:,OP_1 ),nt79(:,OP_DZ)) &
          + int4(r2_79,cht79(:,OP_DR),vzt79(:,OP_1 ),nt79(:,OP_DR)) &
          + int4(r2_79,cht79(:,OP_LP),vzt79(:,OP_1 ),nt79(:,OP_1 ))

     if(itor.eq.1) then
        temp = temp - 2.* &
             int4(r_79,cht79(:,OP_DR),vzt79(:,OP_1),nt79(:,OP_1 )) 
     endif
  end select
...
vectype function torque_visc()
  ...
  select case(ivform)
  case(0)
     temp = int2(vzt79(:,OP_DZ),vis79(:,OP_DZ)) &
          + int2(vzt79(:,OP_DR),vis79(:,OP_DR)) &
          + int2(vzt79(:,OP_GS),vis79(:,OP_1 ))

     if(itor.eq.1) then
        temp = temp - 2.*int3(ri_79,vzt79(:,OP_1),vis79(:,OP_DR))
     endif
  case(1)
     temp = int3(r2_79,vzt79(:,OP_DZ),vis79(:,OP_DZ)) &
          + int3(r2_79,vzt79(:,OP_DR),vis79(:,OP_DR)) &
          + int3(r2_79,vzt79(:,OP_GS),vis79(:,OP_1 ))

     if(itor.eq.1) then
        temp = temp + 4.*int3(r_79,vzt79(:,OP_DR),vis79(:,OP_1))
     endif
  end select
...
vectype function torque_denm()
  ...
  select case(ivform)
  case(0)
     torque_denm = denm*int2(nt79(:,OP_LP),vzt79(:,OP_1))
  case(1)
     torque_denm = denm*int3(r2_79,nt79(:,OP_LP),vzt79(:,OP_1))
  end select
