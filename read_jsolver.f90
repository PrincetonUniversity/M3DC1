...
!
 ...
 2000 format( "rzero = ",1pe12.4,"   bzero = ",1pe12.4,"   gzero = ",1pe12.4,"   pzero ",e12.4,/," xmag,zmag = ",1p2e12.4)
       ...
       do j=1,npsi_jsv
         write(75,802) j,psival_jsv(j),gxx_jsv(j),ffpnorm(j),p_jsv(j),ppxx_jsv(j)
       enddo
      close(75)
!
