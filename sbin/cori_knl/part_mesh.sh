...
SPLIT_SMB=/global/project/projectdirs/mp288/cori/scorec/utilities/split_smb/split_smb
MAKE_MODEL=/global/project/projectdirs/mp288/cori/scorec/utilities/split_smb/make_model
MESH_FILE=mesh.smb
